...
interface CardProps extends React__default.HTMLAttributes<HTMLDivElement>, VariantProps<typeof cardVariants$3>, BaseProps {
    hover?: boolean;
    interactive?: boolean;
    elevation?: Elevation;
}
...
declare function Card$1({ variant, hover, interactive, elevation, padding, onClick, className, children, ...props }: CardProps): React__default.JSX.Element;
...
declare const SelectValue$1: React__default.ForwardRefExoticComponent<SelectPrimitive.SelectValueProps & React__default.RefAttributes<HTMLSpanElement>>;
declare const SelectTrigger$1: React__default.ForwardRefExoticComponent<Omit<SelectPrimitive.SelectTriggerProps & React__default.RefAttributes<HTMLButtonElement>, "ref"> & BaseProps & React__default.RefAttributes<HTMLButtonElement>>;
declare const SelectContent$1: React__default.ForwardRefExoticComponent<Omit<SelectPrimitive.SelectContentProps & React__default.RefAttributes<HTMLDivElement>, "ref"> & React__default.RefAttributes<HTMLDivElement>>;
...
declare const SelectItem$1: React__default.ForwardRefExoticComponent<Omit<SelectPrimitive.SelectItemProps & React__default.RefAttributes<HTMLDivElement>, "ref"> & React__default.RefAttributes<HTMLDivElement>>;
...
declare const TooltipProvider$1: React__default.FC<TooltipPrimitive.TooltipProviderProps>;
declare const Tooltip$1: React__default.FC<TooltipPrimitive.TooltipProps>;
declare const TooltipTrigger$1: React__default.ForwardRefExoticComponent<TooltipPrimitive.TooltipTriggerProps & React__default.RefAttributes<HTMLButtonElement>>;
declare const TooltipContent$1: React__default.ForwardRefExoticComponent<Omit<TooltipPrimitive.TooltipContentProps & React__default.RefAttributes<HTMLDivElement>, "ref"> & React__default.RefAttributes<HTMLDivElement>>;
...
declare const AccordionItem$1: React__default.ForwardRefExoticComponent<Omit<AccordionPrimitive.AccordionItemProps & React__default.RefAttributes<HTMLDivElement>, "ref"> & React__default.RefAttributes<HTMLDivElement>>;
declare const AccordionTrigger$1: React__default.ForwardRefExoticComponent<Omit<AccordionPrimitive.AccordionTriggerProps & React__default.RefAttributes<HTMLButtonElement>, "ref"> & React__default.RefAttributes<HTMLButtonElement>>;
declare const AccordionContent$1: React__default.ForwardRefExoticComponent<Omit<AccordionPrimitive.AccordionContentProps & React__default.RefAttributes<HTMLDivElement>, "ref"> & React__default.RefAttributes<HTMLDivElement>>;
...
type PolymorphicComponentProps<T extends React__default.ElementType, Props = {}> = AsProp<T> & Omit<React__default.ComponentPropsWithoutRef<T>, keyof Props | "as"> & Props;
/**
 * Helper type for the exported component with ref support
 */
type PolymorphicForwardRef<Props, DefaultElement extends React__default.ElementType> = {
    <T extends React__default.ElementType = DefaultElement>(props: PolymorphicComponentProps<T, Props> & {
...
interface ButtonOwnProps extends VariantProps<typeof buttonVariants>, BaseProps {
    loading?: boolean;
    leftIcon?: React__default.ReactNode;
    rightIcon?: React__default.ReactNode;
    iconOnly?: boolean;
}
type ButtonProps<T extends React__default.ElementType = "button"> = PolymorphicComponentProps<T, ButtonOwnProps>;
declare const Button: PolymorphicForwardRef<ButtonOwnProps, "button">;
...
declare const badgeVariants: (props?: ({
    variant?: "default" | "primary" | "secondary" | "ghost" | "success" | "warning" | "outline" | "subtle" | "neutral" | "error" | "blue" | "purple" | "destructive" | "mint" | null | undefined;
    size?: "sm" | "md" | "lg" | null | undefined;
} & class_variance_authority_types.ClassProp) | undefined) => string;
interface BadgeProps extends React__default.HTMLAttributes<HTMLDivElement>, VariantProps<typeof badgeVariants>, BaseProps {
}
...
interface CardOwnProps extends VariantProps<typeof cardVariants>, BaseProps {
    elevation?: Elevation;
    /** Alias for hover variant to match web-app usage */
    interactive?: boolean;
}
declare const Card: PolymorphicForwardRef<CardOwnProps, "div">;
...
declare const TabsList: React__default.ForwardRefExoticComponent<Omit<TabsPrimitive.TabsListProps & React__default.RefAttributes<HTMLDivElement>, "ref"> & VariantProps<(props?: ({
    variant?: "default" | "underline" | "brand" | null | undefined;
} & class_variance_authority_types.ClassProp) | undefined) => string> & React__default.RefAttributes<HTMLDivElement>>;
declare const TabsTrigger: React__default.ForwardRefExoticComponent<Omit<TabsPrimitive.TabsTriggerProps & React__default.RefAttributes<HTMLButtonElement>, "ref"> & VariantProps<(props?: ({
    variant?: "default" | "underline" | "brand" | null | undefined;
