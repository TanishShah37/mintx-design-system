...
import React27__default, { forwardRef, useId, useState, useRef, createContext, useCallback, useEffect, useMemo, Component, useContext } from 'react';
import * as LucideIcons from 'lucide-react';
import { Check, X, EyeOff, Eye, ChevronDown, Minus, Plus, Search, XCircle, AlertCircle, CheckCircle2, Info, ChevronRight, ChevronLeft, MoreHorizontal, Upload, File, Calendar, ChevronsUpDown, Star, ChevronUp, TrendingUp, TrendingDown, AlertTriangle } from 'lucide-react';
...
import { eachDayOfInterval, endOfWeek, endOfMonth, startOfWeek, startOfMonth, format, subMonths, addMonths, isSameDay, isSameMonth, subDays, isWithinInterval } from 'date-fns';
import * as AvatarPrimitive from '@radix-ui/react-avatar';
import { Skeleton as Skeleton$1 } from 'boneyard-js/react';
...
var TooltipContent = React27__default.forwardRef(({ className, sideOffset = 6, ...props }, ref) => /* @__PURE__ */ jsx(
  ...
  ({
      ...
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("span", { className: cn("flex items-center gap-sp-2", loading && "opacity-0"), children: [
            ...
            !iconOnly && /* @__PURE__ */ jsx("span", { children }),
            iconOnly && !loading && children,
            !loading && rightIcon && /* @__PURE__ */ jsx("span", { className: "inline-flex items-center shrink-0", children: rightIcon }),
            badge !== void 0 && /* @__PURE__ */ jsx("span", { className: "ml-1 px-1.5 py-0.5 text-[10px] font-bold bg-white/20 rounded-full min-w-[18px] text-center", children: badge })
          ] })
        ]
      }
    );
    if (tooltip) {
      return /* @__PURE__ */ jsxs(Tooltip, { children: [
        /* @__PURE__ */ jsx(TooltipTrigger, { asChild: true, children: buttonElement }),
...
var Input = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs("div", { className: cn("flex flex-col gap-1.5", fullWidth && "w-full"), children: [
      label && /* @__PURE__ */ jsx("label", { htmlFor: inputId, className: "text-sm font-semibold text-text-secondary leading-none", children: label }),
      ...
      hint && !error && /* @__PURE__ */ jsx("span", { id: `${inputId}-hint`, className: "text-[11px] text-neutral-400", children: hint }),
      error && /* @__PURE__ */ jsx("span", { id: `${inputId}-error`, className: "text-[11px] text-red-500", role: "alert", children: error })
    ] });
  }
);
  ...
  return /* @__PURE__ */ jsxs(
    "label",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: trackVariants({ size }), "aria-hidden": "true", children: /* @__PURE__ */ jsx("div", { className: cn(thumbVariants({ size })) }) }),
        label && /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-text-secondary", children: label })
      ]
    }
  );
}
...
function AppBar({
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      ...props,
      children: /* @__PURE__ */ jsxs(Stack, { direction: "row", align: "center", justify: "between", className: "w-full", children: [
        /* @__PURE__ */ jsxs(Stack, { direction: "row", align: "center", gap: 3, children: [
          leftAction && /* @__PURE__ */ jsx("div", { className: "flex items-center", children: leftAction }),
          title && /* @__PURE__ */ jsx("h1", { className: "text-lg font-bold truncate", children: title })
        ] }),
        rightActions && /* @__PURE__ */ jsx(Stack, { direction: "row", align: "center", gap: 2, children: rightActions })
      ] })
    }
  );
}
      ...
      children: items.map((item) => {
        ...
        return /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("div", { className: cn("transition-transform duration-200", isActive && "scale-110"), children: isActive && item.activeIcon ? item.activeIcon : item.icon }),
    ...
    "nav",
    {
      ...
      children: /* @__PURE__ */ jsx("ol", { className: "flex flex-wrap items-center gap-1.5 list-none p-0 m-0", children: items.map((item, index) => {
        ...
        return /* @__PURE__ */ jsxs(React27__default.Fragment, { children: [
          ...
          !isLast && /* @__PURE__ */ jsx("li", { "aria-hidden": "true", className: "flex items-center text-neutral-600", children: separator })
        ] }, item.label);
      }) })
    }
  );
    ...
    /* @__PURE__ */ jsx(
      DialogPrimitive2.Content,
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-full", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-y-auto min-h-0", children })
        ] })
      }
    )
  ] }) });
  ...
  return /* @__PURE__ */ jsxs(
    "nav",
    {
      ...
      children: [
        ...
        getPages().map((page, index) => /* @__PURE__ */ jsx(React27__default.Fragment, { children: page === "ellipsis" ? /* @__PURE__ */ jsx("div", { className: cn(btnBaseClass, "bg-transparent cursor-default text-neutral-600"), children: /* @__PURE__ */ jsx(MoreHorizontal, { size: 16 }) }) : /* @__PURE__ */ jsx(
          "button",
          {
            className: cn(
              btnBaseClass,
...
var MenuContent = React27__default.forwardRef(({ className, sideOffset = 4, ...props }, ref) => /* @__PURE__ */ jsx(DropdownMenuPrimitive.Portal, { children: /* @__PURE__ */ jsx(
...
var MenuItem = React27__default.forwardRef(({ className, inset, ...props }, ref) => /* @__PURE__ */ jsx(
...
var MenuLabel = React27__default.forwardRef(({ className, inset, ...props }, ref) => /* @__PURE__ */ jsx(
...
var MenuSeparator = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
...
var PopoverContent = React27__default.forwardRef(({ className, align = "center", sideOffset = 4, ...props }, ref) => /* @__PURE__ */ jsx(PopoverPrimitive.Portal, { children: /* @__PURE__ */ jsx(
...
var IconButton = React27__default.forwardRef(
...
var CheckBox = React27__default.forwardRef(({ label, error, className, ...props }, ref) => {
    ...
    /* @__PURE__ */ jsxs("div", { className: cn(
      ...
      /* @__PURE__ */ jsx(
        CheckboxPrimitive.Root,
        {
          ...
          ...props,
          children: /* @__PURE__ */ jsx(CheckboxPrimitive.Indicator, { className: "flex items-center justify-center text-white", children: /* @__PURE__ */ jsx(Check, { size: 13, strokeWidth: 3 }) })
        }
      ),
      label && /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold text-text-primary select-none leading-none", children: label })
    ] }),
    error && /* @__PURE__ */ jsx("p", { className: "text-xs text-red-500 pl-[30px] font-medium", children: error })
  ] });
});
CheckBox.displayName = "CheckBox";
var RadioGroup = RadioGroupPrimitive.Root;
var RadioGroupItem = React27__default.forwardRef(({ label, className, ...props }, ref) => {
  return /* @__PURE__ */ jsxs("div", { className: cn(
    ...
    /* @__PURE__ */ jsx(
      RadioGroupPrimitive.Item,
      {
        ...
        ...props,
        children: /* @__PURE__ */ jsx(RadioGroupPrimitive.Indicator, { className: "flex items-center justify-center", children: /* @__PURE__ */ jsx("div", { className: "h-2.5 w-2.5 rounded-full bg-mint-500" }) })
      }
    ),
    label && /* @__PURE__ */ jsx("span", { className: "text-sm font-body text-primary select-none", children: label })
  ] });
});
RadioGroupItem.displayName = "RadioGroupItem";
var Switch = React27__default.forwardRef(({ label, className, ...props }, ref) => {
  return /* @__PURE__ */ jsxs("div", { className: cn(
    ...
    label && /* @__PURE__ */ jsx("span", { className: "text-sm font-body text-primary select-none font-medium", children: label })
  ] });
});
Switch.displayName = "Switch";
var Slider = React27__default.forwardRef(({ label, error, className, ...props }, ref) => /* @__PURE__ */ jsxs("div", { className: "flex w-full flex-col gap-2.5", children: [
  ...
  /* @__PURE__ */ jsxs(
    SliderPrimitive.Root,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx(SliderPrimitive.Track, { className: "relative h-1 w-full grow overflow-hidden rounded-full bg-neutral-800", children: /* @__PURE__ */ jsx(SliderPrimitive.Range, { className: "absolute h-full bg-gradient-to-r from-mint-500 to-mint-400" }) }),
        /* @__PURE__ */ jsx(SliderPrimitive.Thumb, { className: "block h-5 w-5 rounded-full border-[2.5px] border-surface bg-mint-500 shadow-brand transition-all duration-150 focus-visible:outline-none focus-visible:scale-110 active:scale-95 disabled:pointer-events-none" })
      ]
    }
  ),
...
var Loader = React27__default.forwardRef(
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          label && /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold uppercase tracking-widest text-neutral-500 font-body", children: label })
        ]
      }
    );
  }
...
var TextField = React27__default.forwardRef(
  ({
    className,
    label,
    error,
    ...
    return /* @__PURE__ */ jsxs("div", { className: cn("flex flex-col gap-1.5 w-full", containerClassName, getCommonClasses(props)), children: [
      /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-end", children: [
        ...
        maxLength && /* @__PURE__ */ jsxs("span", { className: "text-[10px] text-muted-foreground uppercase font-medium", children: [
          inputValue.length,
          " / ",
          maxLength
        ] })
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative group", children: [
        leftIcon && /* @__PURE__ */ jsx("div", { className: "absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground group-focus-within:text-primary transition-colors", children: leftIcon }),
        /* @__PURE__ */ jsx(
          "input",
          {
            ref,
        ...
        /* @__PURE__ */ jsxs("div", { className: "absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1.5 h-full", children: [
          loading && /* @__PURE__ */ jsx(Loader, { size: "xs" }),
          !loading && clearable && inputValue && /* @__PURE__ */ jsx(
            "button",
            {
              type: "button",
              onClick: handleClear,
          ...
          !loading && rightIcon && /* @__PURE__ */ jsx("div", { className: "text-muted-foreground group-focus-within:text-primary transition-colors", children: rightIcon }),
          !loading && success && !rightIcon && /* @__PURE__ */ jsx("div", { className: "text-emerald-500", children: /* @__PURE__ */ jsx("svg", { className: "w-4 h-4", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M5 13l4 4L19 7" }) }) })
        ] })
      ] }),
      error && /* @__PURE__ */ jsx("p", { className: "text-xs font-medium text-red-500", children: error }),
      !error && helper && /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: helper }),
      hint && /* @__PURE__ */ jsx("p", { className: "text-[10px] text-muted-foreground italic", children: hint })
    ] });
  }
);
TextField.displayName = "TextField";
var TextFieldPassword = React27__default.forwardRef(
  (props, ref) => {
      ...
      TextField,
      {
        ...
        rightIcon: /* @__PURE__ */ jsx(
          IconButton,
          {
            ...
            icon: showPassword ? /* @__PURE__ */ jsx(EyeOff, { size: 16 }) : /* @__PURE__ */ jsx(Eye, { size: 16 })
          }
        )
      }
    );
...
function DigitInput({
  ...
  return /* @__PURE__ */ jsx("div", { className: cn("flex gap-2 justify-center", containerClassName), children: Array.from({ length }).map((_, i) => /* @__PURE__ */ jsx(
    "input",
    {
      ref: (el) => {
...
var TextArea = React27__default.forwardRef(
...
var SelectTrigger = React27__default.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsxs(
...
var SelectContent = React27__default.forwardRef(({ className, children, position = "popper", ...props }, ref) => /* @__PURE__ */ jsx(SelectPrimitive.Portal, { children: /* @__PURE__ */ jsx(
...
var SelectLabel = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
...
var SelectSeparator = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
...
var SelectItem = React27__default.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsxs(
...
function FileUploader({
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("flex flex-col gap-3 w-full", className), children: [
    label && /* @__PURE__ */ jsx("label", { className: "text-sm font-semibold text-foreground/80", children: label }),
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center text-primary", children: /* @__PURE__ */ jsx(Upload, { size: 24 }) }),
          /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsx("p", { className: "text-sm font-bold", children: "Click or drag to upload" }),
    ...
    selectedFiles.length > 0 && /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 gap-2 mt-2", children: selectedFiles.map((file, i) => /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsx(File, { size: 18, className: "text-primary" }),
            /* @__PURE__ */ jsxs("div", { className: "overflow-hidden", children: [
              /* @__PURE__ */ jsx("p", { className: "text-sm font-medium truncate max-w-[200px]", children: file.name }),
              /* @__PURE__ */ jsxs("p", { className: "text-xs text-muted-foreground italic", children: [
    ...
    /* @__PURE__ */ jsxs(Popover, { children: [
      /* @__PURE__ */ jsx(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsx(
        Button,
        {
          ...
          leftIcon: /* @__PURE__ */ jsx(Calendar, { className: "mr-2 h-4 w-4" }),
          children: value ? format(value, "PPP") : /* @__PURE__ */ jsx("span", { children: placeholder })
        }
      ) }),
      /* @__PURE__ */ jsx(PopoverContent, { className: "w-auto p-4", align: "start", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsx("h4", { className: "font-bold text-sm tracking-tight", children: format(currentMonth, "MMMM yyyy") }),
          /* @__PURE__ */ jsxs("div", { className: "flex gap-1", children: [
            ...
            /* @__PURE__ */ jsx(
              Button,
              {
                ...
                children: /* @__PURE__ */ jsx(ChevronLeft, { className: "rotate-180", size: 16 })
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-7 gap-1", children: [
          ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"].map((day) => /* @__PURE__ */ jsx("div", { className: "text-[10px] font-bold text-center opacity-40 uppercase py-1", children: day }, day)),
          days.map((day) => {
...
function Autocomplete({
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("flex flex-col gap-1.5 w-full", getCommonClasses(props), className), children: [
    label && /* @__PURE__ */ jsx("label", { className: "text-sm font-semibold text-foreground/80 leading-none", children: label }),
    /* @__PURE__ */ jsxs(Popover, { open, onOpenChange: setOpen, children: [
      /* @__PURE__ */ jsx(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsx(
        Button,
        {
          ...
          rightIcon: /* @__PURE__ */ jsx(ChevronsUpDown, { className: "ml-2 h-4 w-4 shrink-0 opacity-50" }),
          children: selectedOption ? selectedOption.label : placeholder
        }
      ) }),
      /* @__PURE__ */ jsx(PopoverContent, { className: "w-[var(--radix-popover-trigger-width)] p-1.5", align: "start", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1.5", children: [
        /* @__PURE__ */ jsx("div", { className: "relative mb-1", children: /* @__PURE__ */ jsx(
          TextField,
          {
            placeholder: "Search...",
            value: searchTerm,
            onChange: (e) => setSearchTerm(e.target.value),
            leftIcon: /* @__PURE__ */ jsx(Search, { className: "h-4 w-4" }),
            size: "sm",
            className: "bg-transparent border-none focus:ring-0"
          }
        ) }),
        /* @__PURE__ */ jsx("div", { className: "max-h-60 overflow-y-auto min-h-0 custom-scrollbar", children: filteredOptions.length === 0 ? /* @__PURE__ */ jsx("p", { className: "p-3 text-xs text-center text-muted-foreground italic", children: "No options found." }) : filteredOptions.map((option) => /* @__PURE__ */ jsxs(
          "button",
          {
            onClick: () => {
            ...
            children: [
              option.label,
              value === option.value && /* @__PURE__ */ jsx(Check, { className: "h-4 w-4" })
            ]
          },
          option.value
        )) })
...
var Fab = React27__default.forwardRef(
    ...
    return /* @__PURE__ */ jsx(
      Button,
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          icon,
          children && /* @__PURE__ */ jsx("span", { className: "font-bold tracking-tight", children })
        ] })
      }
    );
  }
      ...
      children: [
        ...
        onRemove && /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsx(X, { size: size === "sm" ? 8 : 10 })
          }
        )
      ]
    }
...
function Rating({
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("flex flex-col gap-1.5", className), children: [
    label && /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold text-neutral-400 font-body", children: label }),
    /* @__PURE__ */ jsx("div", { className: "flex items-center gap-1", children: Array.from({ length: max }).map((_, i) => {
      const starValue = i + 1;
...
var Avatar = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
...
var AvatarImage = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
...
var AvatarFallback = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "truncate max-w-[160px] uppercase tracking-wider", children: label }),
...
function Image2({
  ...
  const [error, setError] = React27__default.useState(false);
  ...
  return /* @__PURE__ */ jsx("div", { className: cn("overflow-hidden rounded-2xl bg-muted/30", aspectRatioClasses[aspectRatio], containerClassName), children: /* @__PURE__ */ jsx(
    "img",
    {
...
var Table = React27__default.forwardRef(
  ({ className, stickyHeader, striped, compact, ...props }, ref) => /* @__PURE__ */ jsx("div", { className: cn("relative w-full overflow-auto rounded-2xl border border-border", getCommonClasses(props)), children: /* @__PURE__ */ jsx(
    "table",
    {
      ref,
      className: cn(
...
var TableHeader = React27__default.forwardRef(({ className, sticky, ...props }, ref) => /* @__PURE__ */ jsx(
  "thead",
  {
    ref,
    className: cn(
...
var TableBody = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  "tbody",
  {
    ref,
...
var TableFooter = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  "tfoot",
  {
    ref,
    className: cn(
...
var TableRow = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  "tr",
  {
    ref,
    className: cn(
...
var TableHead = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  "th",
  {
    ref,
    className: cn(
...
var TableCell = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  "td",
  {
    ref,
...
var TableCaption = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  "caption",
  {
    ref,
...
function Skeleton({
  ...
  if (lines > 1) {
    return /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-2 w-full", children: Array.from({ length: lines }).map((_, i) => /* @__PURE__ */ jsx(
      "div",
      {
        className: cn(
...
function DataTable({
  ...
  const [sortConfig, setSortConfig] = React27.useState({ key: "", direction: null });
  const filteredData = React27.useMemo(() => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("space-y-4 w-full", getCommonClasses(props), className), children: [
    searchKey && /* @__PURE__ */ jsx("div", { className: "flex items-center gap-4", children: /* @__PURE__ */ jsxs("div", { className: "relative flex-1 max-w-sm", children: [
      /* @__PURE__ */ jsx(Search, { className: "absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground z-10" }),
      /* @__PURE__ */ jsx(
        TextField,
        {
    ...
    /* @__PURE__ */ jsx("div", { className: "rounded-xl border border-border-subtle bg-bg-surface overflow-hidden", children: /* @__PURE__ */ jsxs(Table, { stickyHeader, striped, compact, children: [
      /* @__PURE__ */ jsx(TableHeader, { sticky: stickyHeader, children: /* @__PURE__ */ jsx(TableRow, { className: "hover:bg-transparent border-b border-border-subtle", children: columns.map((column) => /* @__PURE__ */ jsx(
        TableHead,
        {
          className: cn(
          ...
          children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            column.header,
            column.sortable && /* @__PURE__ */ jsx("span", { className: "text-text-tertiary", children: sortConfig.key === (column.accessorKey || column.id) ? sortConfig.direction === "asc" ? /* @__PURE__ */ jsx(ChevronUp, { className: "h-3 w-3" }) : sortConfig.direction === "desc" ? /* @__PURE__ */ jsx(ChevronDown, { className: "h-3 w-3" }) : /* @__PURE__ */ jsx(ChevronsUpDown, { className: "h-3 w-3 opacity-30" }) : /* @__PURE__ */ jsx(ChevronsUpDown, { className: "h-3 w-3 opacity-30" }) })
          ] })
        },
        column.id
      )) }) }),
      /* @__PURE__ */ jsx(TableBody, { children: loading ? Array.from({ length: skeletonRows }).map((_, i) => /* @__PURE__ */ jsx(TableRow, { children: columns.map((column) => /* @__PURE__ */ jsx(TableCell, { children: /* @__PURE__ */ jsx(Skeleton, { className: "h-4 w-full" }) }, column.id)) }, i)) : sortedData.length > 0 ? sortedData.map((row, i) => /* @__PURE__ */ jsx(
        TableRow,
        {
          className: cn(
          ...
          children: columns.map((column) => /* @__PURE__ */ jsx(TableCell, { className: "text-[13px] py-3.5", children: column.cell ? column.cell(row) : column.accessorKey ? String(row[column.accessorKey]) : null }, column.id))
        },
        i
        ...
        TableCell,
        {
          ...
          children: emptyState ? emptyState : /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center gap-1", children: [
            /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-text-primary", children: "No results found" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-text-tertiary", children: "Try adjusting your search or filters" })
          ] })
        }
      ) }) })
    ] }) }),
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-[12px] text-text-tertiary px-2", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        "Showing ",
        /* @__PURE__ */ jsx("b", { children: sortedData.length }),
        " of ",
        /* @__PURE__ */ jsx("b", { children: data.length }),
        " records"
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx("button", { className: "px-3 py-1 border border-border-subtle rounded-md hover:bg-bg-overlay transition-colors", children: "Previous" }),
        /* @__PURE__ */ jsx("button", { className: "px-3 py-1 border border-border-subtle rounded-md hover:bg-bg-overlay transition-colors", children: "Next" })
      ] })
    ] })
  ] });
}
    ...
    "li",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 flex-1", children: [
          icon && /* @__PURE__ */ jsx("div", { className: "text-primary shrink-0", children: icon }),
          /* @__PURE__ */ jsx("div", { className: "flex-1 text-sm font-medium tracking-tight", children })
        ] }),
        secondaryAction && /* @__PURE__ */ jsx("div", { className: "ml-4 shrink-0", children: secondaryAction })
      ]
    }
  );
}
...
var Progress = React27__default.forwardRef(
  ({ className, value, max = 100, size, color = "brand", label, showValue, animated, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        ...props,
        children: [
          (label || showValue) && /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center px-0.5", children: [
            label && /* @__PURE__ */ jsx("span", { className: "text-xs font-semibold text-neutral-400 font-body", children: label }),
            showValue && /* @__PURE__ */ jsxs("span", { className: "text-xs font-mono text-neutral-500", children: [
              Math.round(pct),
              "%"
            ] })
          ] }),
          /* @__PURE__ */ jsx("div", { className: cn(progressVariants({ size })), children: /* @__PURE__ */ jsx(
            "div",
            {
              className: cn(
                barVariants({ color }),
      ...
      children: items.map((item) => {
        ...
        return /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              item.icon && /* @__PURE__ */ jsx("span", { className: "inline-flex items-center", "aria-hidden": "true", children: item.icon }),
...
var Separator3 = React27__default.forwardRef(
...
function Box({
  ...
  return /* @__PURE__ */ jsx(Component2, { className: cn(className), ...props, children });
}
Box.displayName = "Box";
function Divider({
...
var AccordionItem = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
...
var AccordionTrigger = React27__default.forwardRef(({ children, className, ...props }, ref) => /* @__PURE__ */ jsx(AccordionPrimitive.Header, { className: "flex", children: /* @__PURE__ */ jsxs(
  AccordionPrimitive.Trigger,
  {
    ...
    children: [
      children,
      /* @__PURE__ */ jsx(ChevronDown, { className: "h-4 w-4 shrink-0 text-neutral-400 transition-transform duration-200" })
    ]
  }
) }));
AccordionTrigger.displayName = AccordionPrimitive.Trigger.displayName;
var AccordionContent = React27__default.forwardRef(({ children, className, ...props }, ref) => /* @__PURE__ */ jsx(
  AccordionPrimitive.Content,
  {
    ...
    ...props,
    children: /* @__PURE__ */ jsx("div", { className: "pb-4 pt-0 text-neutral-400 leading-relaxed font-body", children })
  }
));
...
var icons = {
  ...
  warning: /* @__PURE__ */ jsx(AlertCircle, { size: 18 }),
  error: /* @__PURE__ */ jsx(XCircle, { size: 18 })
};
var Alert = React27__default.forwardRef(
  ({
    className,
    status = "info",
    variant = "subtle",
    ...
    return /* @__PURE__ */ jsx(AnimatePresence, { children: isVisible && /* @__PURE__ */ jsxs(
      motion$1.div,
      {
        ...
        ...props,
        children: [
          /* @__PURE__ */ jsx("span", { className: "flex-shrink-0 mt-0.5 text-current flex items-center justify-center", children: icon || icons[status ?? "info"] }),
          /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
            title && /* @__PURE__ */ jsx("p", { className: "text-sm font-bold mb-1 tracking-tight leading-none text-current", children: title }),
            description && /* @__PURE__ */ jsx("p", { className: "text-xs opacity-90 leading-relaxed font-body text-current", children: description }),
            children && /* @__PURE__ */ jsx("div", { className: "mt-2 text-xs", children }),
            action && /* @__PURE__ */ jsx("div", { className: "mt-3 flex gap-2", children: action })
          ] }),
...
var ProgressIndicator = React27__default.forwardRef(({ className, value, indicatorClassName, ...props }, ref) => /* @__PURE__ */ jsx(
...
function ProgressTracker({
  ...
  return /* @__PURE__ */ jsx("div", { className: cn("flex w-full justify-between items-start", className), children: steps.map((step, index) => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center flex-1 relative", children: [
      ...
      /* @__PURE__ */ jsx(
        "div",
        {
          ...
          children: isCompleted ? /* @__PURE__ */ jsx(Check, { size: 20, className: "stroke-[3]" }) : /* @__PURE__ */ jsx("span", { className: "text-sm font-bold", children: index + 1 })
        }
      ),
      /* @__PURE__ */ jsxs("div", { className: "mt-3 text-center px-2", children: [
        /* @__PURE__ */ jsx(
          "p",
          {
            className: cn(
        ...
        step.description && /* @__PURE__ */ jsx("p", { className: "text-[10px] text-muted-foreground mt-1 max-w-[120px] line-clamp-2 italic", children: step.description })
      ] })
    ] }, step.id);
  }) });
}
...
var DialogOverlay = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
...
var DialogContent = React27__default.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsxs(DialogPortal, { children: [
...
var DialogTitle = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
...
var DialogDescription = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
...
var ToastViewport = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
...
var Toast = React27__default.forwardRef(({ className, variant, ...props }, ref) => {
  return /* @__PURE__ */ jsx(
    ToastPrimitive.Root,
    {
      ref,
...
var ToastAction = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
...
var ToastClose = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
...
var ToastTitle = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
...
var ToastDescription = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
...
function NotiStackProvider({
  ...
  const [toasts, setToasts] = React27__default.useState([]);
  const addToast = React27__default.useCallback(
    (toast) => {
  ...
  const removeToast = React27__default.useCallback((id) => {
  ...
  return /* @__PURE__ */ jsx(ToastContext.Provider, { value: { addToast, removeToast }, children: /* @__PURE__ */ jsxs(ToastProvider, { children: [
    children,
    toasts.map(({ id, title, description, type, action }) => /* @__PURE__ */ jsxs(
      Toast,
      {
...
var ToastContext = React27__default.createContext({
  addToast: () => "",
  removeToast: () => {
  }
});
var useToast = () => React27__default.useContext(ToastContext);
function Carousel({
  children,
  options,
  className,
      ...
      children: [
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsx("div", { className: "flex", children: React27__default.Children.map(children, (child) => /* @__PURE__ */ jsx("div", { className: "flex-[0_0_100%] min-w-0 px-2", children: child })) })
          }
        ),
        /* @__PURE__ */ jsx(
          "button",
        ...
        /* @__PURE__ */ jsx("div", { className: "flex justify-center gap-1.5 mt-4", children: scrollSnaps.map((_, index) => /* @__PURE__ */ jsx(
          "button",
          {
...
var ScaleIn = ({ children, className, ...props }) => /* @__PURE__ */ jsx(
  motion$1.div,
  {
...
function Nudge({
  ...
  const icons3 = {
    ...
    success: /* @__PURE__ */ jsx(CheckCircle2, { className: "text-green-500", size: 18 }),
    neutral: /* @__PURE__ */ jsx(Info, { className: "text-slate-500", size: 18 })
  };
  return /* @__PURE__ */ jsxs(
    motion$1.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "mt-1", children: icons3[variant] }),
        /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsx("h4", { className: "font-bold text-sm leading-tight mb-1", children: title }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: description }),
...
function NudgesPanel({
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsx(AnimatePresence, { children: nudges.map((nudge) => /* @__PURE__ */ jsx("div", { className: "pointer-events-auto", children: /* @__PURE__ */ jsx(
        Nudge,
        {
          ...nudge,
          onClose,
...
function ConfirmDialog({
  ...
  return /* @__PURE__ */ jsx(Dialog, { open: isOpen, onOpenChange: (open) => !open && onClose(), children: /* @__PURE__ */ jsxs(DialogContent, { className: cn("max-w-[400px]", getCommonClasses(props), className), children: [
    /* @__PURE__ */ jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsx(DialogTitle, { children: title }),
      description && /* @__PURE__ */ jsx(DialogDescription, { children: description })
    ] }),
    /* @__PURE__ */ jsxs(DialogFooter, { className: "mt-6 flex gap-2", children: [
...
var NumberInput = React27__default.forwardRef(
  ({
    value,
    defaultValue,
    min = -Infinity,
    ...
    return /* @__PURE__ */ jsxs("div", { className: cn("relative w-full group", getCommonClasses(props)), children: [
      /* @__PURE__ */ jsx(
        TextField,
        {
          ...props,
      ...
      showStepper && /* @__PURE__ */ jsxs("div", { className: "absolute right-1 top-1/2 -translate-y-1/2 flex items-center gap-1 h-8 px-1 border-l border-border-subtle bg-background rounded-r-lg", children: [
        /* @__PURE__ */ jsx(
          Button,
          {
            type: "button",
            ...
            disabled: value !== void 0 ? value <= min : false,
        ...
        /* @__PURE__ */ jsx(
          Button,
          {
            ...
            className: "h-7 w-7 p-0",
            onClick: () => handleStep(1),
            disabled: value !== void 0 ? value >= max : false,
...
function DateRangePicker({
  ...
  const [currentMonth, setCurrentMonth] = useState(value?.from || /* @__PURE__ */ new Date());
  const presets = [
    { label: "Today", getValue: () => ({ from: /* @__PURE__ */ new Date(), to: /* @__PURE__ */ new Date() }) },
    { label: "Yesterday", getValue: () => ({ from: subDays(/* @__PURE__ */ new Date(), 1), to: subDays(/* @__PURE__ */ new Date(), 1) }) },
    { label: "Last 7 Days", getValue: () => ({ from: subDays(/* @__PURE__ */ new Date(), 7), to: /* @__PURE__ */ new Date() }) },
    { label: "Last 30 Days", getValue: () => ({ from: subDays(/* @__PURE__ */ new Date(), 30), to: /* @__PURE__ */ new Date() }) },
    { label: "This Month", getValue: () => ({ from: startOfMonth(/* @__PURE__ */ new Date()), to: endOfMonth(/* @__PURE__ */ new Date()) }) }
  ];
    ...
    /* @__PURE__ */ jsxs(Popover, { children: [
      /* @__PURE__ */ jsx(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsx(
        Button,
        {
          ...
          leftIcon: /* @__PURE__ */ jsx(Calendar, { className: "mr-2 h-4 w-4" }),
          children: value?.from ? value.to ? /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsxs(PopoverContent, { className: "w-auto p-0 flex flex-col md:flex-row divide-y md:divide-y-0 md:divide-x", align: "start", children: [
        /* @__PURE__ */ jsx("div", { className: "p-3 flex flex-col gap-1 w-full md:w-36 bg-muted/20", children: presets.map((preset) => /* @__PURE__ */ jsx(
          "button",
          {
            onClick: () => {
        ...
        /* @__PURE__ */ jsxs("div", { className: "p-4 flex flex-col gap-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsx("h4", { className: "font-bold text-sm tracking-tight", children: format(currentMonth, "MMMM yyyy") }),
            /* @__PURE__ */ jsxs("div", { className: "flex gap-1", children: [
              /* @__PURE__ */ jsx(Button, { variant: "ghost", size: "sm", iconOnly: true, onClick: () => setCurrentMonth(subMonths(currentMonth, 1)), children: /* @__PURE__ */ jsx(ChevronLeft, { size: 16 }) }),
              /* @__PURE__ */ jsx(Button, { variant: "ghost", size: "sm", iconOnly: true, onClick: () => setCurrentMonth(addMonths(currentMonth, 1)), children: /* @__PURE__ */ jsx(ChevronRight, { size: 16 }) })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-7 gap-1", children: [
            ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"].map((day) => /* @__PURE__ */ jsx("div", { className: "text-[10px] font-bold text-center opacity-40 uppercase py-1", children: day }, day)),
...
function EmptyState({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "flex h-16 w-16 items-center justify-center rounded-full bg-muted/40 mb-4", children: icon || /* @__PURE__ */ jsx(Search, { className: "h-8 w-8 text-text-tertiary" }) }),
        /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-text-primary tracking-tight", children: title }),
        description && /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-text-secondary max-w-sm mx-auto", children: description }),
        action && /* @__PURE__ */ jsx(
          Button,
          {
            variant: "secondary",
  ...
  render() {
    if (this.state.hasError) {
      ...
      return /* @__PURE__ */ jsxs("div", { className: cn(
        ...
        /* @__PURE__ */ jsx(Button, { variant: "secondary", onClick: this.handleReset, children: "Try again" })
      ] });
    }
...
function LoadingOverlay({
  ...
  return /* @__PURE__ */ jsx(AnimatePresence, { children: isLoading && /* @__PURE__ */ jsxs(
    motion$1.div,
    {
      initial: { opacity: 0 },
      animate: { opacity: 1 },
      ...
      children: [
        /* @__PURE__ */ jsx(Loader, { size: "lg", color: "brand" }),
        text && /* @__PURE__ */ jsx("p", { className: "mt-4 text-sm font-semibold text-text-primary tracking-tight", children: text })
      ]
    }
  ) });
}
var SearchInput = React27__default.forwardRef(
...
var dotVariants = cva(
  "w-2 h-2 rounded-full shrink-0",
  {
    variants: {
      status: {
        live: "bg-green-500 shadow-[0_0_0_0_rgba(34,197,94,0.5)] animate-pulse-live",
        paused: "bg-amber-500",
...
function Stepper({
  ...
  return /* @__PURE__ */ jsx("div", { className: cn(
    ...
    getCommonClasses(props),
    className
  ), children: steps.map((step, index) => /* @__PURE__ */ jsx(React27__default.Fragment, { children: /* @__PURE__ */ jsxs("div", { className: cn(
    "flex items-center gap-3",
    ...
    /* @__PURE__ */ jsx(
      "div",
      {
        className: cn(
          ...
          step.status === "complete" ? "bg-mint-500 border-mint-500 text-white" : step.status === "current" ? "border-mint-500 text-mint-600 bg-white shadow-[0_0_0_4px_rgba(0,179,138,0.1)]" : "border-neutral-200 text-neutral-400 bg-white"
        ),
        children: step.status === "complete" ? /* @__PURE__ */ jsx(Check, { className: "h-5 w-5" }) : /* @__PURE__ */ jsx("span", { className: "text-sm font-bold", children: index + 1 })
      }
    ),
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col min-w-0", children: [
      ...
      step.description && orientation === "vertical" && /* @__PURE__ */ jsx("span", { className: "text-xs text-text-tertiary mt-0.5", children: step.description })
    ] }),
    orientation === "horizontal" && index < steps.length - 1 && /* @__PURE__ */ jsx("div", { className: "flex-1 h-[2px] mx-4 bg-muted overflow-hidden", children: /* @__PURE__ */ jsx(
      "div",
      {
        className: cn(
...
function Collapsible({
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("overflow-hidden", variants[variant], getCommonClasses(props), className), children: [
    /* @__PURE__ */ jsxs(
      "button",
      {
        onClick: toggle,
        ...
        children: [
          /* @__PURE__ */ jsx("div", { className: "flex-1 font-semibold text-text-primary", children: title }),
          /* @__PURE__ */ jsx(
            motion$1.div,
            {
              animate: { rotate: isOpen ? 180 : 0 },
              transition: { duration: 0.2, ease: "easeInOut" },
              children: /* @__PURE__ */ jsx(ChevronDown, { className: "h-5 w-5 text-text-tertiary group-hover:text-text-primary transition-colors" })
            }
          )
        ]
      }
    ...
    /* @__PURE__ */ jsx(AnimatePresence, { initial: false, children: isOpen && /* @__PURE__ */ jsx(
      motion$1.div,
      {
        ...
        children: /* @__PURE__ */ jsx("div", { className: "pt-4", children })
      }
    ) })
  ] });
}
...
function PriceChange({
  ...
  return /* @__PURE__ */ jsxs(
    "span",
    {
      ...
      children: [
        showIcon && /* @__PURE__ */ jsx("span", { className: "inline-flex items-center shrink-0", children: dir === "up" ? /* @__PURE__ */ jsx(ArrowUp, {}) : dir === "down" ? /* @__PURE__ */ jsx(ArrowDown, {}) : /* @__PURE__ */ jsx(Dash, {}) }),
        /* @__PURE__ */ jsx("span", { className: "tabular-nums", children: formatted })
      ]
    }
  );
}
...
function MetricCard({
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn(cardVariants2({ compact }), className), ...props, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: cn(
      ...
      data.prefix && /* @__PURE__ */ jsx("span", { className: "text-lg text-neutral-600 mr-[1px]", children: data.prefix }),
      typeof data.value === "number" ? data.value.toLocaleString("en-IN") : data.value,
      data.suffix && /* @__PURE__ */ jsx("span", { className: "text-sm font-body text-neutral-400 font-normal ml-[2px]", children: data.suffix })
    ] }),
    data.delta !== void 0 && /* @__PURE__ */ jsx(
      PriceChange,
      {
        value: data.delta,
        percent: void 0,
...
function Sparkline({
  ...
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      ...
      style: { height },
      children: [
        /* @__PURE__ */ jsx("title", { children: `Sparkline: ${direction} trend` }),
        /* @__PURE__ */ jsx("polygon", { points: closedPts, fill: colors.fill, stroke: "none" }),
        /* @__PURE__ */ jsx(
          "polyline",
          {
            points: pts,
...
function StockCard({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start mb-sp-3", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "font-display text-xl font-bold text-neutral-900 tracking-tight", children: data.ticker }),
            /* @__PURE__ */ jsx("div", { className: "text-xs text-neutral-400 mt-0.5", children: data.name })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "text-right flex flex-col items-end gap-0.5", children: [
            /* @__PURE__ */ jsxs("div", { className: cn(priceVariants2({ direction })), children: [
              "\u20B9",
        ...
        data.sparkline && /* @__PURE__ */ jsx("div", { className: "my-sp-3 rounded-sm overflow-hidden", children: /* @__PURE__ */ jsx(Sparkline, { data: data.sparkline, direction, height: 40 }) }),
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-3 gap-sp-2 pt-sp-3 border-t border-neutral-100", children: [
          data.open !== void 0 && /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "text-[10px] text-neutral-400 uppercase tracking-wider mb-0.5", children: "Open" }),
            /* @__PURE__ */ jsx("div", { className: "font-mono text-sm font-semibold text-neutral-900 tabular-nums", children: data.open.toLocaleString("en-IN") })
          ] }),
          data.high !== void 0 && /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "text-[10px] text-neutral-400 uppercase tracking-wider mb-0.5", children: direction === "down" ? "Low" : "High" }),
            /* @__PURE__ */ jsx("div", { className: "font-mono text-sm font-semibold text-neutral-900 tabular-nums", children: (direction === "down" ? data.low : data.high)?.toLocaleString(
              "en-IN"
            ) })
          ] }),
          data.volume && /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "text-[10px] text-neutral-400 uppercase tracking-wider mb-0.5", children: "Vol" }),
            /* @__PURE__ */ jsx("div", { className: "font-mono text-sm font-semibold text-neutral-900 tabular-nums", children: data.volume })
          ] })
        ] })
      ]
    }
      ...
      motion$1.div,
      {
        ...
        children: displayItems.map((item, index) => /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("span", { className: "font-bold text-sm tracking-tight", children: item.symbol }),
              /* @__PURE__ */ jsx("span", { className: "font-mono text-sm", children: item.price }),
              /* @__PURE__ */ jsxs(
                "span",
                {
                  className: cn(
                  ...
                  children: [
                    item.isPositive ? /* @__PURE__ */ jsx(TrendingUp, { size: 12 }) : /* @__PURE__ */ jsx(TrendingDown, { size: 12 }),
                    item.change,
                    "%"
                  ]
                }
...
function MarketStatus({
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("flex items-center gap-3 px-4 py-2 rounded-full bg-background/40 border border-border w-fit", className), children: [
    /* @__PURE__ */ jsxs("div", { className: "relative flex h-2.5 w-2.5", children: [
      /* @__PURE__ */ jsx("span", { className: cn("animate-ping absolute inline-flex h-full w-full rounded-full opacity-75", current.pulse) }),
      /* @__PURE__ */ jsx("span", { className: cn("relative inline-flex rounded-full h-2.5 w-2.5", current.color) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
      /* @__PURE__ */ jsx("span", { className: "text-[10px] uppercase tracking-wider font-bold opacity-50 leading-none", children: market }),
...
var DEFAULT_NAV = [
  {
    label: "Dashboard",
    href: "/dashboard",
    icon: /* @__PURE__ */ jsxs("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round", children: [
  ...
  },
  {
    ...
    badge: "Pro",
    icon: /* @__PURE__ */ jsx("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ jsx("polygon", { points: "22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3" }) })
  },
  {
    label: "FII / DII",
    href: "/fii-dii",
    icon: /* @__PURE__ */ jsxs("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round", children: [
      ...
      /* @__PURE__ */ jsx("line", { x1: "2", x2: "22", y1: "12", y2: "12" })
    ] })
  },
  {
    label: "Academy",
...
function NavLink({
  ...
  return /* @__PURE__ */ jsxs(
    import_link.default,
    {
      ...
      children: [
        item.icon && /* @__PURE__ */ jsx("span", { className: cn("opacity-70", active && "opacity-100 text-[var(--mint)]"), children: item.icon }),
        item.label,
        item.badge && /* @__PURE__ */ jsx(NavBadge, { text: item.badge })
      ]
    }
  );
}
  ...
  return /* @__PURE__ */ jsxs("div", { ref, className: "relative", children: [
    /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          item.icon && /* @__PURE__ */ jsx("span", { className: "opacity-70", children: item.icon }),
          item.label,
          /* @__PURE__ */ jsx(
            "svg",
            {
      ...
      "div",
      {
        ...
        children: item.children?.map((child) => /* @__PURE__ */ jsxs(
          import_link.default,
          {
            ...
            children: [
              child.icon && /* @__PURE__ */ jsx("span", { className: "opacity-60", children: child.icon }),
              child.label,
              child.badge && /* @__PURE__ */ jsx(NavBadge, { text: child.badge })
            ]
          },
          child.href
        ))
...
function UserMenu({
  ...
  return /* @__PURE__ */ jsxs("div", { ref, className: "relative", children: [
    ...
    open && /* @__PURE__ */ jsxs("div", { className: cn(
      ...
      /* @__PURE__ */ jsxs("div", { className: "border-b border-[var(--bd)] px-4 py-3", children: [
        /* @__PURE__ */ jsx("p", { className: "text-[13px] font-semibold text-[var(--t1)] truncate", children: user.name }),
        /* @__PURE__ */ jsx("p", { className: "text-[11px] text-[var(--t3)] truncate", children: user.email })
      ] }),
      ...
      user.plan === "free" && /* @__PURE__ */ jsx("div", { className: "border-t border-[var(--bd)] p-2", children: /* @__PURE__ */ jsx(
        import_link.default,
        {
          href: "/pricing",
          onClick: () => setOpen(false),
      ...
      /* @__PURE__ */ jsx("div", { className: "border-t border-[var(--bd)] py-1", children: /* @__PURE__ */ jsx(
        "button",
        {
          onClick: () => {
            setOpen(false);
...
function NotificationBell({ count = 0 }) {
  return /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round", children: [
          /* @__PURE__ */ jsx("path", { d: "M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9" }),
          /* @__PURE__ */ jsx("path", { d: "M10.3 21a1.94 1.94 0 0 0 3.4 0" })
        ] }),
        count > 0 && /* @__PURE__ */ jsx("span", { className: "absolute right-1 top-1 flex h-3.5 w-3.5 items-center justify-center rounded-full bg-[var(--red)] font-mono text-[8px] font-bold text-white", children: count > 9 ? "9+" : count })
      ]
    }
  );
}
function MarketStatus2() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 rounded-full border border-[var(--bd)] px-2.5 py-1 text-[11px] font-medium text-[var(--t3)]", children: [
    /* @__PURE__ */ jsxs("span", { className: "relative flex h-1.5 w-1.5", children: [
      cfg.pulse && /* @__PURE__ */ jsx(
        "span",
        {
      ...
      /* @__PURE__ */ jsx("span", { className: "relative inline-flex h-1.5 w-1.5 rounded-full", style: { background: cfg.color } })
    ] }),
    /* @__PURE__ */ jsx("span", { className: "hidden sm:block", children: cfg.label })
  ] });
}
function MobileMenu({
  items,
  ...
  if (!open) return null;
  return /* @__PURE__ */ jsxs("div", { className: "fixed inset-0 z-50 flex flex-col bg-[var(--surf)] lg:hidden", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-b border-[var(--bd)] px-6 py-4", children: [
      /* @__PURE__ */ jsx(Logo, {}),
      /* @__PURE__ */ jsx(
        "button",
        {
          ...
          children: /* @__PURE__ */ jsx("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ jsx("path", { d: "M18 6 6 18M6 6l12 12" }) })
        }
      )
    ] }),
    /* @__PURE__ */ jsx("nav", { className: "flex flex-1 flex-col overflow-y-auto px-4 py-4 gap-1", children: items.map((item) => /* @__PURE__ */ jsxs(
      import_link.default,
      {
        href: item.href,
        onClick: onClose,
    ...
    /* @__PURE__ */ jsx("div", { className: "border-t border-[var(--bd)] p-4", children: user ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2", children: [
      /* @__PURE__ */ jsxs("div", { className: "px-2 text-xs text-[var(--t3)]", children: [
        "Signed in as ",
        /* @__PURE__ */ jsx("strong", { className: "text-[var(--t2)]", children: user.email })
      ] }),
      user.plan === "free" && /* @__PURE__ */ jsx(
        import_link.default,
        {
          href: "/pricing",
          onClick: onClose,
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(
      "header",
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "mx-auto flex h-14 max-w-screen-xl items-center justify-between gap-4 px-4 lg:px-8", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
            /* @__PURE__ */ jsx(Logo, {}),
            /* @__PURE__ */ jsx("nav", { className: "ml-4 hidden items-center gap-0.5 lg:flex", "aria-label": "Main navigation", children: navItems.map(
              (item) => item.children ? /* @__PURE__ */ jsx(
                NavDropdown,
                {
                  item,
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(MarketStatus2, {}),
            user ? /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx(NotificationBell, { count: 3 }),
              /* @__PURE__ */ jsx(UserMenu, { user, onLogout })
            ] }) : cta ? cta : /* @__PURE__ */ jsxs("div", { className: "hidden items-center gap-2 lg:flex", children: [
              /* @__PURE__ */ jsx(
                import_link.default,
                {
                  href: "/auth/login",
...
var SocialLinks = () => /* @__PURE__ */ jsx("div", { className: "flex items-center gap-3", children: [
  {
    label: "Twitter / X",
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxs("svg", { width: "15", height: "15", viewBox: "0 0 24 24", fill: "currentColor", children: [
...
function AppFooter({
  ...
  if (compact) {
    return /* @__PURE__ */ jsx(
      "footer",
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "mx-auto flex max-w-screen-xl flex-col items-center justify-between gap-3 px-4 py-5 sm:flex-row lg:px-8", children: [
          /* @__PURE__ */ jsx(FooterLogo, {}),
          /* @__PURE__ */ jsx("div", { className: "flex flex-wrap items-center justify-center gap-x-4 gap-y-1", children: LEGAL_LINKS.map((l) => /* @__PURE__ */ jsx(
            import_link2.default,
            {
              href: l.href,
          ...
          /* @__PURE__ */ jsxs("span", { className: "font-mono text-[10px] text-[var(--t4)]", children: [
            "\xA9 ",
  ...
  return /* @__PURE__ */ jsx(
    "footer",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-screen-xl px-4 py-12 lg:px-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-8 sm:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "col-span-2 flex flex-col gap-4 sm:col-span-3 lg:col-span-1 xl:col-span-2", children: [
            /* @__PURE__ */ jsx(FooterLogo, {}),
            /* @__PURE__ */ jsx("p", { className: "max-w-[240px] text-xs leading-relaxed text-[var(--t3)]", children: "Institutional-grade market intelligence for Indian retail investors. SEBI-compliant. Always educational. Never advisory." }),
            /* @__PURE__ */ jsx(SocialLinks, {}),
            /* @__PURE__ */ jsx("div", { className: "mt-1", children: /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1.5 rounded-full border border-[var(--bd)] bg-[var(--bd2)] px-2.5 py-1 font-mono text-[10px] text-[var(--t4)]", children: [
              /* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-[var(--grn)]" }),
              "NSE data | Supabase snapshots"
            ] }) })
          ] }),
          columns.map((col) => /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3", children: [
            /* @__PURE__ */ jsx("h3", { className: "text-[11px] font-bold uppercase tracking-[0.1em] text-[var(--t3)]", children: col.title }),
            /* @__PURE__ */ jsx("ul", { className: "flex flex-col gap-2", children: col.links.map((link) => /* @__PURE__ */ jsx("li", { children: link.external ? /* @__PURE__ */ jsxs(
              "a",
              {
                href: link.href,
                target: "_blank",
                ...
                children: [
                  link.label,
                  /* @__PURE__ */ jsx("svg", { width: "10", height: "10", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", className: "opacity-40", children: /* @__PURE__ */ jsx("path", { d: "M7 7h10v10M7 17 17 7" }) })
                ]
              }
            ) : /* @__PURE__ */ jsx(
              import_link2.default,
        ...
        showDisclaimer && /* @__PURE__ */ jsx("div", { className: "mt-10 rounded-[var(--r2)] border border-[var(--bd)] bg-[var(--bd2)] px-4 py-3", children: /* @__PURE__ */ jsxs("p", { className: "text-center text-[10.5px] leading-relaxed text-[var(--t4)]", children: [
          /* @__PURE__ */ jsx("span", { className: "font-semibold text-[var(--t3)]", children: "SEBI Disclaimer - " }),
          SEBI_DISCLAIMER
        ] }) }),
        /* @__PURE__ */ jsxs("div", { className: "mt-8 flex flex-col items-center justify-between gap-3 border-t border-[var(--bd)] pt-6 sm:flex-row", children: [
          /* @__PURE__ */ jsxs("span", { className: "font-mono text-[11px] text-[var(--t4)]", children: [
            "\xA9 ",
            (/* @__PURE__ */ new Date()).getFullYear(),
            " Mintx Technologies Pvt Ltd | mintx.trade | mintx.in"
          ] }),
          /* @__PURE__ */ jsx("div", { className: "flex items-center gap-4", children: LEGAL_LINKS.map((l) => /* @__PURE__ */ jsx(
            import_link2.default,
            {
              href: l.href,
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 font-mono text-[10px] text-[var(--t4)]", children: [
            /* @__PURE__ */ jsx("span", { children: "Built on" }),
            /* @__PURE__ */ jsx("span", { className: "rounded px-1 py-0.5 bg-[var(--bd2)] border border-[var(--bd)]", children: "Next.js 14" }),
            /* @__PURE__ */ jsx("span", { children: "|" }),
            /* @__PURE__ */ jsx("span", { className: "rounded px-1 py-0.5 bg-[var(--bd2)] border border-[var(--bd)]", children: "Supabase" }),
            /* @__PURE__ */ jsx("span", { children: "|" }),
            /* @__PURE__ */ jsx("span", { className: "rounded px-1 py-0.5 bg-[var(--bd2)] border border-[var(--bd)]", children: "Vercel" })
          ] })
        ] })
      ] })
    }
...
function IconMark({
  ...
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      ...
      "aria-hidden": "true",
      children: [
        /* @__PURE__ */ jsx("rect", { width: "96", height: "96", rx, fill: bgColor }),
        /* @__PURE__ */ jsx(
          "path",
          {
        ...
        /* @__PURE__ */ jsx("circle", { cx: "62", cy: "30", r: "6", fill: strokeColor }),
        /* @__PURE__ */ jsx(
          "path",
          {
            d: "M20 72H76",
...
function Wordmark({
  ...
  return /* @__PURE__ */ jsxs(
    "span",
    {
      ...
      children: [
        "Mint",
        /* @__PURE__ */ jsx("span", { style: { color: accentColor }, children: "x" })
      ]
    }
  );
}
function MintxLogo({
  ...
  if (variant === "mark") {
    return /* @__PURE__ */ jsx("span", { className: cn("inline-flex items-center shrink-0", className), style, "aria-label": "Mintx", children: /* @__PURE__ */ jsx(IconMark, { size: markSize, theme }) });
  }
  if (variant === "wordmark") {
    return /* @__PURE__ */ jsx("span", { className: cn("inline-flex items-center shrink-0", className), style, "aria-label": "Mintx", children: /* @__PURE__ */ jsx(Wordmark, { fontSize: wordSize, theme }) });
  }
  return /* @__PURE__ */ jsxs(
    "span",
    {
      ...
      "aria-label": "Mintx",
      children: [
        /* @__PURE__ */ jsx(IconMark, { size: markSize, theme }),
        /* @__PURE__ */ jsx(Wordmark, { fontSize: wordSize, theme })
      ]
    }
  );
}
...
function ThemeToggle({
  ...
  return /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      children: [
        isDark ? /* @__PURE__ */ jsx(SunIcon, {}) : /* @__PURE__ */ jsx(MoonIcon, {}),
        showLabel && /* @__PURE__ */ jsx("span", { className: "leading-none", children: isDark ? "Light" : "Dark" })
      ]
    }
  );
}
...
var ChevronRight6 = () => /* @__PURE__ */ jsx(
  "svg",
  {
    width: "12",
    height: "12",
...
var CollapseIcon = () => /* @__PURE__ */ jsxs(
  "svg",
  {
    width: "16",
    height: "16",
    ...
    return /* @__PURE__ */ jsxs("li", { children: [
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            item.icon && /* @__PURE__ */ jsx("span", { className: "inline-flex items-center shrink-0 color-inherit w-[18px] h-[18px]", "aria-hidden": "true", children: item.icon }),
            !collapsed && /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx("span", { className: "flex-1 overflow-hidden text-ellipsis whitespace-nowrap", children: item.label }),
      ...
      hasChildren && isExpanded && !collapsed && /* @__PURE__ */ jsx("ul", { className: "list-none p-0 m-0 pl-sp-4", children: item.children.map((child) => renderItem(child, depth + 1)) })
    ] }, item.id);
  };
  return /* @__PURE__ */ jsxs(
    "aside",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: cn(
          ...
          collapsed ? /* @__PURE__ */ jsx(MintxLogo, { variant: "mark", size: "sm" }) : /* @__PURE__ */ jsx(MintxLogo, { variant: "full", size: "sm" }),
        ...
        /* @__PURE__ */ jsx("nav", { className: "flex-1 overflow-y-auto overflow-x-hidden py-sp-3 scrollbar-thin scrollbar-thumb-neutral-200", children: sections.map((section, si) => /* @__PURE__ */ jsxs("div", { className: "px-sp-2 pb-sp-3", children: [
          section.label && !collapsed && /* @__PURE__ */ jsx("span", { className: "block text-[10px] font-bold uppercase tracking-wider text-neutral-400 px-sp-2 py-sp-1 mt-sp-3", children: section.label }),
          section.label && !collapsed && /* @__PURE__ */ jsx("div", { className: "h-[1px] bg-neutral-100 mx-sp-2 mb-sp-2" }),
          /* @__PURE__ */ jsx("ul", { className: "list-none p-0 m-0", children: section.items.map((item) => renderItem(item)) })
        ] }, si)) }),
        /* @__PURE__ */ jsx("div", { className: cn(
          "shrink-0 p-sp-4 border-t border-neutral-100 flex items-center",
          collapsed && "justify-center p-sp-3"
        ), children: footer ?? /* @__PURE__ */ jsx(ThemeToggle, { showLabel: !collapsed }) })
      ]
    }
  );
}
...
function SupportLiveBar({
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("flex items-center justify-between p-sp-2 px-sp-4 bg-surface border-t border-neutral-100 gap-sp-3", className), children: [
    marketStatus && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-sp-2 text-xs text-neutral-600 flex-1 min-w-0 overflow-hidden", children: [
      /* @__PURE__ */ jsx(
        "span",
        {
      ...
      /* @__PURE__ */ jsx("span", { className: "font-semibold text-neutral-900 shrink-0 whitespace-nowrap overflow-hidden text-ellipsis", children: marketStatus.label ?? cfg.label }),
      marketStatus.nextEvent && /* @__PURE__ */ jsxs("span", { className: "text-neutral-400 whitespace-nowrap overflow-hidden text-ellipsis", children: [
        "\xB7 ",
        marketStatus.nextEvent,
        marketStatus.nextEventTime && /* @__PURE__ */ jsx("span", { className: "font-mono ml-0.5", children: marketStatus.nextEventTime })
      ] })
    ] }),
    /* @__PURE__ */ jsxs(
      "button",
        ...
        children: [
          /* @__PURE__ */ jsx(
            "svg",
            {
              ...
              strokeLinejoin: "round",
              "aria-hidden": "true",
              children: /* @__PURE__ */ jsx("path", { d: "M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z" })
            }
          ),
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs(
          ...
          ` }),
                /* @__PURE__ */ jsxs("filter", { id: "glow2", x: "-30%", y: "-30%", width: "160%", height: "160%", children: [
              ...
              [-200, -100, 0, 100, 200].map((v) => /* @__PURE__ */ jsxs("g", { children: [
                /* @__PURE__ */ jsx(
                  "line",
                  {
                    x1: v,
              ...
              [
              ...
              ].map(({ y, pct, lbl, cls, bold }) => /* @__PURE__ */ jsxs("g", { className: cn("pi", cls), children: [
                /* @__PURE__ */ jsx(
                  "line",
                  {
                    x1: "-290",
                ...
                bold && /* @__PURE__ */ jsxs(Fragment, { children: [
                  ...
                  /* @__PURE__ */ jsxs("circle", { cx: "-65", cy: y, r: "4", fill: "#00B38A", children: [
                    /* @__PURE__ */ jsx(
                      "animate",
                      {
                        attributeName: "r",
              ...
              /* @__PURE__ */ jsxs("g", { className: "pi d8", children: [
                /* @__PURE__ */ jsx(
                  "rect",
                  {
                    x: "58",
...
function Hero({
  ...
  return /* @__PURE__ */ jsx("section", { className: cn("relative z-10 mx-auto max-w-7xl px-6 pb-20 pt-10 lg:px-12 lg:pt-14", className), children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-20", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:max-w-2xl", children: [
      ...
      features.length > 0 && /* @__PURE__ */ jsx("div", { className: "rev-up mt-5 flex flex-wrap gap-2 text-center", children: features.map((f) => /* @__PURE__ */ jsx(
        "span",
        {
      ...
      /* @__PURE__ */ jsx("div", { className: "rev-up mt-8 w-full max-w-[440px]", children }),
      socialProof && /* @__PURE__ */ jsx("div", { className: "rev-up mt-6 flex items-center gap-3", children: socialProof })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "rev-fd relative lg:flex lg:justify-end", children: [
      /* @__PURE__ */ jsx(FibSpiral, { theme }),
      chips?.left && /* @__PURE__ */ jsxs(
        "div",
        {
...
function HowItWorks({
  ...
  return /* @__PURE__ */ jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl px-6 py-20 lg:px-12", children: [
        /* @__PURE__ */ jsxs("div", { className: "mb-12 flex items-center gap-5", children: [
          /* @__PURE__ */ jsx(
            "span",
            {
              style: {
          ...
          /* @__PURE__ */ jsx("div", { className: "h-px flex-1", style: { background: divider } })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "relative grid grid-cols-1 gap-12 md:grid-cols-3", children: [
          /* @__PURE__ */ jsx(
            "div",
            {
              "aria-hidden": true,
          ...
          steps.map((step, i) => /* @__PURE__ */ jsxs("div", { className: "relative flex flex-col gap-4", children: [
            /* @__PURE__ */ jsx(
              "div",
              {
                ...
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsx(
                    "svg",
                    {
                      ...
                      strokeLinecap: "round",
                      strokeLinejoin: "round",
                      children: /* @__PURE__ */ jsx("path", { d: "M7 17 17 7M7 7h10v10" })
                    }
                  )
                }
              )
...
function Differentiators({
  ...
  const dark = theme === "dark";
  const divider = dark ? "rgba(232,239,237,0.05)" : "rgba(20,31,29,0.06)";
  return /* @__PURE__ */ jsxs("section", { className: cn("mx-auto max-w-7xl px-6 py-20 lg:px-12", className), children: [
    /* @__PURE__ */ jsxs("div", { className: "mb-10 flex items-center gap-5", children: [
      /* @__PURE__ */ jsx(
        "span",
        {
          style: {
    ...
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 gap-4 md:grid-cols-3", children: items.map((item, i) => /* @__PURE__ */ jsx(DiffCard, { item, i, theme }, item.rank)) })
  ] });
}
...
function WaitlistForm({
  ...
  return /* @__PURE__ */ jsxs("form", { onSubmit: submit, noValidate: true, className: cn("w-full", className), children: [
    /* @__PURE__ */ jsxs(
      "div",
      {
...
function StatsSection({
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: stats.map((s) => /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("span", { style: { fontSize: "11px", color: t4 }, children: s.sub })
          ]
        },
        s.label
      ))
...
function CommunitySection({
  ...
  return /* @__PURE__ */ jsxs("section", { className: cn("relative overflow-hidden", className), children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative mx-auto max-w-2xl px-6 py-24 text-center lg:px-10", children: [
      /* @__PURE__ */ jsx(
        "span",
        {
          style: {
      ...
      /* @__PURE__ */ jsx("div", { className: "mx-auto mt-8 max-w-md", children }),
      perks.length > 0 && /* @__PURE__ */ jsx("div", { className: "mt-8 flex flex-wrap items-center justify-center gap-x-6 gap-y-3", children: perks.map((perk) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
        /* @__PURE__ */ jsx(
          "svg",
          {
            width: "12",
        ...
        /* @__PURE__ */ jsx("span", { style: { fontSize: "12px", color: t3 }, children: perk })
      ] }, perk)) })
    ] })
  ] });
}
var Table2 = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx("div", { className: "relative w-full overflow-auto rounded-xl border border-border-subtle", children: /* @__PURE__ */ jsx(
  "table",
  {
    ref,
...
var TableHeader2 = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx("thead", { ref, className: cn("[&_tr]:border-b bg-surface-base/30", className), ...props }));
TableHeader2.displayName = "TableHeader";
var TableBody2 = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  "tbody",
  {
    ref,
    className: cn("[&_tr:last-child]:border-0", className),
...
var TableFooter2 = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  "tfoot",
  {
    ref,
    className: cn(
...
var TableRow2 = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  "tr",
  {
    ref,
    className: cn(
...
var TableHead2 = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  "th",
  {
    ref,
    className: cn(
...
var TableCell2 = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  "td",
  {
    ref,
...
var TableCaption2 = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  "caption",
  {
    ref,
...
var Input2 = forwardRef(
  ({
    ...
    const inputId = id ?? uid;
    const hasError = !!error;
    return /* @__PURE__ */ jsxs("div", { className: cn("flex flex-col gap-sp-1", fullWidth && "w-full"), children: [
      label && /* @__PURE__ */ jsx("label", { htmlFor: inputId, className: "text-sm font-medium text-neutral-600", children: label }),
      /* @__PURE__ */ jsxs("div", { className: "relative", children: [
        leftIcon && /* @__PURE__ */ jsx(
          "span",
          {
...
function DataTable2({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-4 w-full", children: [
    searchKey && /* @__PURE__ */ jsx("div", { className: "flex items-center gap-4", children: searchKey && /* @__PURE__ */ jsxs("div", { className: "relative flex-1 max-w-sm", children: [
      /* @__PURE__ */ jsx(Search, { className: "absolute left-sp-2.5 top-sp-2.5 h-4 w-4 text-neutral-400" }),
      /* @__PURE__ */ jsx(
        Input2,
        {
          placeholder: searchPlaceholder,
    ...
    /* @__PURE__ */ jsx("div", { className: "rounded-xl border border-neutral-150 bg-surface overflow-hidden shadow-sm", children: /* @__PURE__ */ jsxs(Table2, { children: [
      /* @__PURE__ */ jsx(TableHeader2, { children: /* @__PURE__ */ jsx(TableRow2, { className: "hover:bg-transparent border-b border-neutral-150", children: columns.map((column) => /* @__PURE__ */ jsx(
        TableHead2,
        {
          className: cn(
      ...
      /* @__PURE__ */ jsx(TableBody2, { children: sortedData.length > 0 ? sortedData.map((row, i) => /* @__PURE__ */ jsx(
        TableRow2,
        {
          className: cn(
          ...
          children: columns.map((column) => /* @__PURE__ */ jsx(TableCell2, { className: "text-[13px] py-sp-3.5", children: column.cell ? column.cell(row) : column.accessorKey ? String(row[column.accessorKey]) : null }, column.id))
        },
        i
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-[12px] text-text-tertiary px-sp-2 font-body", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        "Showing ",
        /* @__PURE__ */ jsx("b", { children: sortedData.length }),
        " of ",
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-sp-2", children: [
        /* @__PURE__ */ jsx("button", { className: "px-sp-3 py-sp-1 border border-neutral-150 rounded-md hover:bg-neutral-100 transition-colors", children: "Previous" }),
        /* @__PURE__ */ jsx("button", { className: "px-sp-3 py-sp-1 border border-neutral-150 rounded-md hover:bg-neutral-100 transition-colors", children: "Next" })
      ] })
    ] })
  ] });
}
...
function Status2({
  ...
  return /* @__PURE__ */ jsxs(
    "span",
    {
      className: cn(statusVariants2({ status }), className),
      style,
      "aria-label": `${label ?? statusLabels2[status]} status`,
      children: [
        /* @__PURE__ */ jsx(
          "span",
          {
            className: cn(
              dotVariants3({ status: pulse ? status : "offline" }),
              !pulse && "animate-none"
            ),
            "aria-hidden": "true"
          }
        ),
        /* @__PURE__ */ jsx("span", { children: label ?? statusLabels2[status] })
      ]
    }
  );
}
Status2.displayName = "Status";
...
function MarketStatus3({
  ...
  const current = config[status];
  return /* @__PURE__ */ jsxs("div", { className: cn("flex items-center gap-sp-3 px-sp-4 py-sp-2 rounded-full bg-surface/40 border border-neutral-150 w-fit", className), children: [
    /* @__PURE__ */ jsxs("div", { className: "relative flex h-2.5 w-2.5", children: [
      /* @__PURE__ */ jsx("span", { className: cn("animate-ping absolute inline-flex h-full w-full rounded-full opacity-75", current.pulse) }),
      /* @__PURE__ */ jsx("span", { className: cn("relative inline-flex rounded-full h-2.5 w-2.5", current.color) })
    ] }),
...
function PriceChange2({
  ...
  return /* @__PURE__ */ jsxs(
    "span",
    {
      ...
      "aria-label": `${dir === "up" ? "Up" : dir === "down" ? "Down" : "Flat"} ${formatted}`,
      children: [
        showIcon && /* @__PURE__ */ jsx("span", { className: "inline-flex items-center shrink-0", children: dir === "up" ? /* @__PURE__ */ jsx(ArrowUp2, {}) : dir === "down" ? /* @__PURE__ */ jsx(ArrowDown2, {}) : /* @__PURE__ */ jsx(Dash2, {}) }),
        /* @__PURE__ */ jsx("span", { className: "tabular-nums", children: formatted })
      ]
    }
  );
...
function MetricCard2({
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn(cardVariants3({ compact }), className), children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: cn(
      ...
      data.prefix && /* @__PURE__ */ jsx("span", { className: "text-lg text-text-secondary mr-[1px]", children: data.prefix }),
      typeof data.value === "number" ? data.value.toLocaleString("en-IN") : data.value,
      data.suffix && /* @__PURE__ */ jsx("span", { className: "text-sm font-body text-text-tertiary font-normal ml-[2px]", children: data.suffix })
    ] }),
    data.delta !== void 0 && /* @__PURE__ */ jsx(
      PriceChange2,
      {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start mb-sp-3", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "font-display text-xl font-bold text-text-primary tracking-tight", children: data.ticker }),
            /* @__PURE__ */ jsx("div", { className: "text-xs text-text-tertiary mt-0.5", children: data.name })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "text-right flex flex-col items-end gap-0.5", children: [
            /* @__PURE__ */ jsxs("div", { className: cn(priceVariants4({ direction })), children: [
              "\u20B9",
              data.price.toLocaleString("en-IN")
            ] }),
            /* @__PURE__ */ jsx(
        ...
        data.sparkline && /* @__PURE__ */ jsx("div", { className: "my-sp-3 rounded-sm overflow-hidden", children: /* @__PURE__ */ jsx(Sparkline2, { data: data.sparkline, direction, height: 40 }) }),
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-3 gap-sp-2 pt-sp-3 border-t border-border-subtle", children: [
          data.open !== void 0 && /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "text-[10px] text-text-tertiary uppercase tracking-wider mb-0.5", children: "Open" }),
            /* @__PURE__ */ jsx("div", { className: "font-mono text-sm font-semibold text-text-primary tabular-nums", children: data.open.toLocaleString("en-IN") })
          ] }),
          data.high !== void 0 && /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "text-[10px] text-text-tertiary uppercase tracking-wider mb-0.5", children: direction === "down" ? "Low" : "High" }),
            /* @__PURE__ */ jsx("div", { className: "font-mono text-sm font-semibold text-text-primary tabular-nums", children: (direction === "down" ? data.low : data.high)?.toLocaleString(
              "en-IN"
            ) })
          ] }),
          data.volume && /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "text-[10px] text-text-tertiary uppercase tracking-wider mb-0.5", children: "Vol" }),
            /* @__PURE__ */ jsx("div", { className: "font-mono text-sm font-semibold text-text-primary tabular-nums", children: data.volume })
          ] })
        ] })
      ]
    }
...
var DialogOverlay2 = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  DialogPrimitive2.Overlay,
  {
    ref,
    className: cn(
...
var DialogContent2 = React27__default.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsxs(DialogPortal2, { children: [
  ...
  /* @__PURE__ */ jsxs(
    DialogPrimitive2.Content,
    {
      ...
      children: [
        children,
        /* @__PURE__ */ jsxs(DialogPrimitive2.Close, { className: "absolute right-sp-4 top-sp-4 rounded-sm opacity-70 ring-offset-surface transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-brand focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-surface-elevated data-[state=open]:text-text-tertiary", children: [
          /* @__PURE__ */ jsx(X, { className: "h-4 w-4 text-text-primary" }),
          /* @__PURE__ */ jsx("span", { className: "sr-only", children: "Close" })
        ] })
      ]
    }
...
var DialogTitle2 = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  DialogPrimitive2.Title,
  {
    ref,
    className: cn(
...
var DialogDescription2 = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  DialogPrimitive2.Description,
  {
    ref,
...
function Drawer2({
  ...
  return /* @__PURE__ */ jsx(DialogPrimitive2.Root, { open, onOpenChange, children: /* @__PURE__ */ jsxs(DialogPrimitive2.Portal, { children: [
    /* @__PURE__ */ jsx(DialogPrimitive2.Overlay, { className: "fixed inset-0 z-50 bg-black/80 backdrop-blur-sm data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0" }),
    /* @__PURE__ */ jsx(
      DialogPrimitive2.Content,
      {
        className: cn(
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-full", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-sp-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
              title && /* @__PURE__ */ jsx(DialogPrimitive2.Title, { className: "text-lg font-bold leading-none tracking-tight text-text-primary", children: title }),
              description && /* @__PURE__ */ jsx(DialogPrimitive2.Description, { className: "text-sm text-text-tertiary font-body", children: description })
            ] }),
            /* @__PURE__ */ jsxs(DialogPrimitive2.Close, { className: "rounded-md opacity-70 transition-opacity hover:opacity-100 focus:outline-none disabled:pointer-events-none text-text-primary", children: [
              /* @__PURE__ */ jsx(X, { className: "h-5 w-5" }),
              /* @__PURE__ */ jsx("span", { className: "sr-only", children: "Close" })
            ] })
          ] }),
...
var MenuContent2 = React27__default.forwardRef(({ className, sideOffset = 4, ...props }, ref) => /* @__PURE__ */ jsx(DropdownMenuPrimitive.Portal, { children: /* @__PURE__ */ jsx(
  DropdownMenuPrimitive.Content,
  {
    ref,
    sideOffset,
...
var MenuItem2 = React27__default.forwardRef(({ className, inset, ...props }, ref) => /* @__PURE__ */ jsx(
  DropdownMenuPrimitive.Item,
  {
    ref,
    className: cn(
...
var MenuLabel2 = React27__default.forwardRef(({ className, inset, ...props }, ref) => /* @__PURE__ */ jsx(
  DropdownMenuPrimitive.Label,
  {
    ref,
...
var MenuSeparator2 = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  DropdownMenuPrimitive.Separator,
  {
    ref,
...
MenuSeparator2.displayName = DropdownMenuPrimitive.Separator.displayName;
    ...
    "nav",
    {
      ...
      children: /* @__PURE__ */ jsx("ol", { className: "flex flex-wrap items-center gap-1.5 list-none p-0 m-0", children: items.map((item, index) => {
        ...
        return /* @__PURE__ */ jsxs(React27__default.Fragment, { children: [
          ...
          !isLast && /* @__PURE__ */ jsx("li", { "aria-hidden": "true", className: "flex items-center text-neutral-300 px-sp-1", children: separator })
        ] }, item.label);
      }) })
    }
  );
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("flex items-center justify-between p-sp-2 px-sp-4 bg-surface border-t border-neutral-100 gap-sp-3", className), children: [
    marketStatus && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-sp-2 text-xs text-neutral-600 flex-1 min-w-0 overflow-hidden", children: [
      /* @__PURE__ */ jsx(
        "span",
        {
          className: dotVariants4({ color: cfg.color, pulse: cfg.pulse }),
          "aria-hidden": "true"
        }
      ),
      /* @__PURE__ */ jsx("span", { className: "font-semibold text-neutral-900 shrink-0 whitespace-nowrap overflow-hidden text-ellipsis", children: marketStatus.label ?? cfg.label }),
...
function Nudge2({
  ...
  const icons3 = {
    info: /* @__PURE__ */ jsx(Info, { className: "text-blue-500", size: 18 }),
    warning: /* @__PURE__ */ jsx(AlertTriangle, { className: "text-amber-500", size: 18 }),
    success: /* @__PURE__ */ jsx(CheckCircle2, { className: "text-mint-500", size: 18 }),
    neutral: /* @__PURE__ */ jsx(Info, { className: "text-neutral-400", size: 18 })
  };
  return /* @__PURE__ */ jsxs(
    motion$1.div,
    {
...
var AreaChart = ({ data, color = "#00B38A", ...props }) => /* @__PURE__ */ jsx(
  BaseChart,
  {
    ...props,
    renderFn: (_LWT, chart) => {
...
var CandlestickChart = ({ data, ...props }) => /* @__PURE__ */ jsx(
  BaseChart,
  {
    ...props,
    renderFn: (_LWT, chart) => {
...
var BaselineChart = ({ data, color = "#00B38A", ...props }) => /* @__PURE__ */ jsx(
  BaseChart,
  {
    ...props,
    renderFn: (_LWT, chart) => {
...
var VolumeChart = ({ data, color = "#00B38A", ...props }) => /* @__PURE__ */ jsx(
  BaseChart,
  {
    ...props,
    renderFn: (_LWT, chart) => {
...
var AdvancedRealTimeChart = ({
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsx("div", { id: `tv_chart_${symbol.replace(/[^a-zA-Z0-9]/g, "_")}`, ref: container, style: { height: "100%", width: "100%" } })
    }
  );
};
var TechnicalAnalysis = ({
  ...
  return /* @__PURE__ */ jsx("div", { className: "tradingview-widget-container", ref: container, children: /* @__PURE__ */ jsx("div", { className: "tradingview-widget-container__widget" }) });
};
var MarketOverview = ({
  theme = "dark",
  width = "100%",
...
function AssetLibrary({
  ...
  return /* @__PURE__ */ jsxs("div", { style: { fontFamily: "'DM Sans', sans-serif", color: "var(--text-primary, var(--text-primary, #E8EFED))", background: "var(--bg-base, #080E0D)", padding: "24px", borderRadius: "16px", border: "1px solid rgba(232,239,237,0.08)" }, children: [
    ...
    activeTab === "icons" ? /* @__PURE__ */ jsx(IconLibrary, {}) : /* @__PURE__ */ jsx(IllustrationLibrary, {})
  ] });
}
function IconLibrary() {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsx("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(100px, 1fr))", gap: "12px" }, children: filtered.map((icon) => /* @__PURE__ */ jsx(AssetCard, { name: icon.name, type: "icon" }, icon.name)) })
  ] });
}
function IllustrationLibrary() {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsx("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(150px, 1fr))", gap: "16px" }, children: filtered.map((illus) => /* @__PURE__ */ jsx(AssetCard, { id: illus.id, name: illus.name, type: "illustration" }, illus.id)) })
  ] });
}
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        })() : /* @__PURE__ */ jsx("div", { dangerouslySetInnerHTML: { __html: SVGS[id] || "" }, style: { transform: "scale(0.5)" } }) }),
        /* @__PURE__ */ jsx("span", { style: { fontSize: "11px", color: "var(--text-tertiary)", textAlign: "center", wordBreak: "break-all" }, children: name })
      ]
    }
  );
}
var ToastProvider2 = ToastPrimitive.Provider;
var ToastViewport2 = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  ToastPrimitive.Viewport,
  {
    ref,
    className: cn(
...
ToastViewport2.displayName = ToastPrimitive.Viewport.displayName;
var toastVariants2 = cva(
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-2xl border p-4 pr-8 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-80 data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-bottom-full data-[state=closed]:slide-out-to-right-full",
  {
    variants: {
      variant: {
...
var Toast2 = React27__default.forwardRef(({ className, variant, ...props }, ref) => {
  return /* @__PURE__ */ jsx(
    ToastPrimitive.Root,
    {
      ref,
...
var ToastAction3 = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  ToastPrimitive.Action,
  {
    ref,
    className: cn(
...
var ToastClose2 = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  ToastPrimitive.Close,
  {
    ref,
    className: cn(
...
var ToastTitle2 = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  ToastPrimitive.Title,
  {
    ref,
    className: cn("text-sm font-bold", className),
...
var ToastDescription2 = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  ToastPrimitive.Description,
  {
    ref,
    className: cn("text-sm opacity-90", className),
  ...
  return /* @__PURE__ */ jsx(ToastContext2.Provider, { value: { addToast, removeToast }, children: /* @__PURE__ */ jsxs(ToastProvider2, { children: [
    ...
    toasts.map(({ id, title, description, type, action }) => /* @__PURE__ */ jsxs(
      Toast2,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "grid gap-1", children: [
            title && /* @__PURE__ */ jsx(ToastTitle2, { children: title }),
            description && /* @__PURE__ */ jsx(ToastDescription2, { children: description })
          ] }),
          action,
          /* @__PURE__ */ jsx(ToastClose2, {})
        ]
      },
      id
    )),
...
var ToastContext2 = React27__default.createContext({
  addToast: () => "",
  removeToast: () => {
  }
});
var Accordion2 = AccordionPrimitive.Root;
var AccordionItem2 = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  AccordionPrimitive.Item,
  {
    ref,
    className: cn("border-b border-border/10", className),
...
var AccordionTrigger2 = React27__default.forwardRef(({ children, className, ...props }, ref) => /* @__PURE__ */ jsx(AccordionPrimitive.Header, { className: "flex", children: /* @__PURE__ */ jsxs(
  AccordionPrimitive.Trigger,
  {
    ref,
    className: cn(
...
var AccordionContent2 = React27__default.forwardRef(({ children, className, ...props }, ref) => /* @__PURE__ */ jsx(
  AccordionPrimitive.Content,
  {
    ref,
    className: cn(
...
var icons2 = {
  default: /* @__PURE__ */ jsx(Info, { size: 20 }),
...
var Alert2 = React27__default.forwardRef(
  ({ className, variant = "default", title, description, children, ...props }, ref) => {
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ref,
        role: "alert",
        className: cn(alertVariants2({ variant }), className),
        ...props,
        children: [
          /* @__PURE__ */ jsx("span", { className: "flex-shrink-0 mt-0.5 text-current opacity-90", children: icons2[variant ?? "default"] }),
          /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
            title && /* @__PURE__ */ jsx("p", { className: "text-sm font-bold mb-sp-1 tracking-tight leading-none text-current font-display", children: title }),
            description && /* @__PURE__ */ jsx("p", { className: "text-xs opacity-90 leading-relaxed font-body text-current", children: description }),
            children
          ] })
        ]
...
var FadeIn2 = ({ children, className, ...props }) => /* @__PURE__ */ jsx(
  motion$1.div,
  {
    initial: { opacity: 0 },
    animate: { opacity: 1 },
...
var SlideIn2 = ({ children, className, direction = "up", ...props }) => {
  const variants = {
    up: { y: 20, opacity: 0 },
    down: { y: -20, opacity: 0 },
    left: { x: 20, opacity: 0 },
...
var ScaleIn2 = ({ children, className, ...props }) => /* @__PURE__ */ jsx(
  motion$1.div,
  {
    initial: { scale: 0.95, opacity: 0 },
    animate: { scale: 1, opacity: 1 },
...
var PopoverTrigger2 = PopoverPrimitive.Trigger;
var PopoverContent2 = React27__default.forwardRef(({ className, align = "center", sideOffset = 4, ...props }, ref) => /* @__PURE__ */ jsx(PopoverPrimitive.Portal, { children: /* @__PURE__ */ jsx(
  PopoverPrimitive.Content,
  {
    ref,
    align,
...
function Autocomplete2({
  ...
  const selectedOption = options.find((opt) => opt.value === value);
  return /* @__PURE__ */ jsxs("div", { className: cn("flex flex-col gap-sp-1.5 w-full", className), children: [
    label && /* @__PURE__ */ jsx("label", { className: "text-sm font-semibold text-neutral-900/80 leading-none font-display", children: label }),
    /* @__PURE__ */ jsxs(Popover2, { open, onOpenChange: setOpen, children: [
      ...
      /* @__PURE__ */ jsx(PopoverContent2, { className: "w-[var(--radix-popover-trigger-width)] p-1.5", align: "start", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1.5", children: [
        /* @__PURE__ */ jsxs("div", { className: "relative flex items-center px-sp-2 py-sp-2 border-b border-neutral-150/50 mb-sp-1", children: [
          /* @__PURE__ */ jsx(Search, { className: "h-4 w-4 absolute left-sp-3 opacity-40 text-neutral-400" }),
          /* @__PURE__ */ jsx(
            "input",
            {
        ...
        /* @__PURE__ */ jsx("div", { className: "max-h-60 overflow-y-auto min-h-0 custom-scrollbar", children: filteredOptions.length === 0 ? /* @__PURE__ */ jsx("p", { className: "p-sp-3 text-xs text-center text-neutral-400 italic font-body", children: "No options found." }) : filteredOptions.map((option) => /* @__PURE__ */ jsxs(
          "button",
          {
            onClick: () => {
              onChange?.(option.value);
...
var Avatar2 = React27__default.forwardRef(({ className, src, alt, initials, size, status, ...props }, ref) => /* @__PURE__ */ jsxs("div", { className: "relative inline-block", children: [
  /* @__PURE__ */ jsxs(
    AvatarPrimitive.Root,
    {
      ref,
  ...
  status && /* @__PURE__ */ jsx("span", { className: statusVariants3({ status }) })
] }));
...
Backdrop2.displayName = "Backdrop";
var badgeVariants2 = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-bold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 uppercase tracking-wider",
  {
    variants: {
      variant: {
        default: "border-transparent bg-mint-500 text-neutral-0 shadow-[0_4px_16px_rgba(0,179,138,0.25)] hover:bg-mint-600",
        secondary: "border-transparent bg-neutral-100 text-neutral-600 hover:bg-neutral-200",
        destructive: "border-transparent bg-red-500 text-neutral-0 shadow hover:bg-red-600",
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            className: cn(
              "absolute left-4 top-1/2 -translate-y-1/2 z-10 w-9 h-9 rounded-full flex items-center justify-center transition-all duration-200",
              "bg-black/80 backdrop-blur-md border border-neutral-150 text-mint-500",
              "hover:bg-neutral-800 hover:border-mint-500/50",
              "opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto",
              prevBtnDisabled && "opacity-0 invisible"
            ),
        ...
        /* @__PURE__ */ jsx("div", { className: "flex justify-center gap-1.5 mt-4", children: scrollSnaps.map((_, index) => /* @__PURE__ */ jsx(
          "button",
          {
            ...
            className: cn(
              "h-1.5 rounded-full transition-all duration-300",
              index === selectedIndex ? "w-5 bg-mint-500 shadow-[0_4px_16px_rgba(0,179,138,0.25)]" : "w-1.5 bg-neutral-100/20 hover:bg-neutral-100/40"
            ),
            "aria-label": `Go to slide ${index + 1}`
          },
          index
...
var CheckBox2 = React27__default.forwardRef(({ label, error, className, ...props }, ref) => {
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-sp-1", children: [
    /* @__PURE__ */ jsxs("div", { className: cn(
      ...
      label && /* @__PURE__ */ jsx("span", { className: "text-sm font-body text-text-primary select-none leading-none", children: label })
    ] }),
    error && /* @__PURE__ */ jsx("p", { className: "text-xs text-red-500 pl-[30px] font-medium", children: error })
  ] });
});
...
var colorVariants2 = {
  default: "bg-surface text-neutral-400 border-neutral-150",
  primary: "bg-mint-500/10 text-mint-500 border-mint-500/30",
  secondary: "bg-neutral-800 text-neutral-0 border-neutral-700",
  success: "bg-mint-500/10 text-mint-500 border-mint-500/25",
...
function Chip2({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      className: cn(
        "inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold font-body transition-all duration-150 border",
        variant === "filled" && colorVariants2[color],
        variant === "outline" && "bg-transparent",
        variant === "outline" && color === "default" && "border-border text-neutral-400",
        variant === "outline" && color !== "default" && colorVariants2[color].replace(/bg-[^\s]*/, "bg-transparent"),
        variant === "ghost" && "bg-transparent border-transparent",
        className
      ),
      ...props,
...
function DatePicker2({
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("flex flex-col gap-1.5 w-full", className), children: [
    ...
    /* @__PURE__ */ jsxs(Popover2, { children: [
      ...
      /* @__PURE__ */ jsx(PopoverContent2, { className: "w-auto p-4", align: "start", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsx("h4", { className: "font-bold text-sm tracking-tight", children: format(currentMonth, "MMMM yyyy") }),
          /* @__PURE__ */ jsxs("div", { className: "flex gap-1", children: [
            /* @__PURE__ */ jsx(
...
DigitInput2.displayName = "DigitInput";
function Divider2({
  orientation = "horizontal",
  className,
  ...props
...
var IconButton2 = React27__default.forwardRef(
  ({ icon, className, ...props }, ref) => {
    return /* @__PURE__ */ jsx(
      Button2,
      {
...
FileUploader2.displayName = "FileUploader";
function Image4({
  className,
  aspectRatio = "none",
  fallback,
...
ImageList2.displayName = "ImageList";
function List2({ children, className }) {
  return /* @__PURE__ */ jsx("ul", { className: cn("flex flex-col gap-1 w-full", className), children });
}
List2.displayName = "List";
var loaderVariants2 = cva(
  "flex flex-col items-center justify-center gap-2",
  {
    variants: {
      size: {
...
var Loader2 = React27__default.forwardRef(
  ({ className, size, color = "brand", label, ...props }, ref) => {
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ref,
        className: cn(loaderVariants2({ size, color }), className),
        ...props,
        children: [
          /* @__PURE__ */ jsxs(
            "svg",
...
var Progress2 = React27__default.forwardRef(
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("div", { className: cn(progressVariants2({ size })), children: /* @__PURE__ */ jsx(
            "div",
            {
              className: cn(barVariants2({ color })),
              style: { transform: `translateX(-${100 - pct}%)` }
            }
          ) })
        ]
...
var ProgressIndicator2 = React27__default.forwardRef(({ className, value, indicatorClassName, ...props }, ref) => /* @__PURE__ */ jsx(
  ProgressPrimitive.Root,
  {
    ref,
    className: cn(
...
ProgressIndicator2.displayName = ProgressPrimitive.Root.displayName;
...
var RadioGroup2 = RadioGroupPrimitive.Root;
var RadioGroupItem2 = React27__default.forwardRef(({ label, className, ...props }, ref) => {
  return /* @__PURE__ */ jsxs("div", { className: cn(
    "flex items-center gap-2.5",
    props.disabled ? "cursor-not-allowed opacity-50" : "cursor-pointer"
  ), children: [
...
var SelectTrigger2 = React27__default.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsxs(
  SelectPrimitive.Trigger,
  {
    ref,
    className: cn(
      "flex h-sp-11 w-full items-center justify-between rounded-xl border border-border-default bg-surface px-sp-3 py-sp-2 text-sm shadow-sm ring-offset-surface placeholder:text-text-tertiary focus:outline-none focus:ring-2 focus:ring-mint-500/20 focus:border-mint-500 disabled:cursor-not-allowed disabled:opacity-50 transition-all font-body text-text-primary",
      className
    ),
    ...props,
    children: [
      children,
      /* @__PURE__ */ jsx(SelectPrimitive.Icon, { asChild: true, children: /* @__PURE__ */ jsx(ChevronDown, { className: "h-4 w-4 opacity-50 text-text-tertiary" }) })
    ]
  }
));
SelectTrigger2.displayName = SelectPrimitive.Trigger.displayName;
var SelectContent2 = React27__default.forwardRef(({ className, children, position = "popper", ...props }, ref) => /* @__PURE__ */ jsx(SelectPrimitive.Portal, { children: /* @__PURE__ */ jsx(
  SelectPrimitive.Content,
  {
    ref,
    className: cn(
      "relative z-50 min-w-[8rem] overflow-hidden rounded-xl border border-border-default bg-surface/80 backdrop-blur-md text-text-primary shadow-xl animate-in fade-in zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
      position === "popper" && "data-[side=bottom]:translate-y-1 data-[side=left]:-translate-x-1 data-[side=right]:translate-x-1 data-[side=top]:-translate-y-1",
      className
    ),
    position,
...
var SelectItem2 = React27__default.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsxs(
  SelectPrimitive.Item,
  {
    ref,
    className: cn(
      "relative flex w-full cursor-default select-none items-center rounded-lg py-sp-2 pl-sp-8 pr-sp-2.5 text-sm outline-none transition-colors focus:bg-surface-elevated focus:text-text-brand data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className
    ),
    ...props,
    children: [
      /* @__PURE__ */ jsx("span", { className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center", children: /* @__PURE__ */ jsx(SelectPrimitive.ItemIndicator, { children: /* @__PURE__ */ jsx(Check, { className: "h-4 w-4 text-mint-500 stroke-[3]" }) }) }),
      /* @__PURE__ */ jsx(SelectPrimitive.ItemText, { children })
    ]
  }
));
SelectItem2.displayName = SelectPrimitive.Item.displayName;
var Separator5 = React27__default.forwardRef(
  ({ className, orientation = "horizontal", decorative = true, ...props }, ref) => /* @__PURE__ */ jsx(
    "div",
    {
      ref,
...
var Slider2 = React27__default.forwardRef(({ label, error, className, ...props }, ref) => /* @__PURE__ */ jsxs("div", { className: "flex w-full flex-col gap-2.5", children: [
  label && /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold font-body text-neutral-400", children: label }),
  /* @__PURE__ */ jsxs(
    SliderPrimitive.Root,
    {
...
var Switch2 = React27__default.forwardRef(({ label, className, ...props }, ref) => {
  return /* @__PURE__ */ jsxs("div", { className: cn(
    "flex items-center gap-3",
    props.disabled ? "cursor-not-allowed opacity-50" : "cursor-pointer"
  ), children: [
...
var TabsList = React27__default.forwardRef(({ className, variant, ...props }, ref) => /* @__PURE__ */ jsx(
  TabsPrimitive.List,
  {
    ref,
...
var TabsTrigger = React27__default.forwardRef(({ className, variant, ...props }, ref) => /* @__PURE__ */ jsx(
...
var TabsContent = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
...
TagGroup2.displayName = "TagGroup";
var TextArea2 = React27__default.forwardRef(
  ({ className, label, error, ...props }, ref) => {
    return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-sp-1.5 w-full", children: [
      label && /* @__PURE__ */ jsx("label", { className: "text-sm font-semibold text-text-primary/80 leading-none font-display", children: label }),
      /* @__PURE__ */ jsx(
        "textarea",
        {
          ref,
...
var TextField2 = React27__default.forwardRef(
  ({ className, label, error, hint, leftIcon, rightIcon, fullWidth, ...props }, ref) => {
    return /* @__PURE__ */ jsxs("div", { className: cn("flex flex-col gap-sp-1.5 w-full", fullWidth && "w-full"), children: [
      label && /* @__PURE__ */ jsx("label", { className: "text-sm font-semibold text-text-primary leading-none font-display", children: label }),
      /* @__PURE__ */ jsxs("div", { className: "relative group", children: [
        leftIcon && /* @__PURE__ */ jsx("div", { className: "absolute left-sp-3 top-1/2 -translate-y-1/2 text-text-tertiary group-focus-within:text-text-brand transition-colors", children: leftIcon }),
        /* @__PURE__ */ jsx(
          "input",
          {
            ref,
        ...
        rightIcon && /* @__PURE__ */ jsx("div", { className: "absolute right-sp-3 top-1/2 -translate-y-1/2 text-text-tertiary group-focus-within:text-text-brand transition-colors", children: rightIcon })
      ] }),
      hint && !error && /* @__PURE__ */ jsx("p", { className: "text-[11px] text-text-tertiary font-medium", children: hint }),
      error && /* @__PURE__ */ jsx("p", { className: "text-xs font-medium text-red-500", children: error })
    ] });
  }
);
TextField2.displayName = "TextField";
var TextFieldPassword2 = React27__default.forwardRef(
  (props, ref) => {
    const [showPassword, setShowPassword] = useState(false);
    return /* @__PURE__ */ jsx(
      TextField2,
...
TextFieldPassword2.displayName = "TextFieldPassword";
var toggleVariants2 = cva(
  "inline-flex items-center gap-sp-2 cursor-pointer select-none disabled:opacity-50 disabled:cursor-not-allowed",
  {
    variants: {
      size: {
...
function Toggle2({
  ...
  return /* @__PURE__ */ jsxs(
    ...
    {
      htmlFor: uid,
      className: cn(toggleVariants2({ size }), className),
      style,
      children: [
        /* @__PURE__ */ jsx(
          "input",
        ...
        /* @__PURE__ */ jsx("div", { className: trackVariants2({ size }), "aria-hidden": "true", children: /* @__PURE__ */ jsx("div", { className: cn(thumbVariants2({ size }), "peer-checked:translate-x-[18px]!") }) }),
        label && /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-neutral-600", children: label })
      ]
    }
  );
}
...
var TooltipContent2 = React27__default.forwardRef(({ className, sideOffset = 6, ...props }, ref) => /* @__PURE__ */ jsx(
  TooltipPrimitive.Content,
  {
    ref,
    sideOffset,
