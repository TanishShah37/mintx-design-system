...
var Avatar2 = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  AvatarPrimitive.Root,
  {
    ref,
    className: cn(
...
var AvatarImage2 = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  AvatarPrimitive.Image,
  {
    ref,
    className: cn("aspect-square h-full w-full object-cover", className),
...
AvatarImage2.displayName = AvatarPrimitive.Image.displayName;
var AvatarFallback2 = React27__default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  AvatarPrimitive.Fallback,
  {
    ref,
    className: cn(
...
AvatarFallback2.displayName = AvatarPrimitive.Fallback.displayName;
function Backdrop2({
  show,
  onClick,
  className,
