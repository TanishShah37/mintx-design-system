  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-start mb-sp-3">
        <div>
          <div className="font-display text-xl font-bold text-neutral-900 tracking-tight">{data.ticker}</div>
          <div className="text-xs text-neutral-400 mt-0.5">{data.name}</div>
        </div>
      ...
      {/* Stats row */}
      <div className="grid grid-cols-3 gap-sp-2 pt-sp-3 border-t border-neutral-100">
        {data.open !== undefined && (
          <div>
            <div className="text-[10px] text-neutral-400 uppercase tracking-wider mb-0.5">Open</div>
            <div className="font-mono text-sm font-semibold text-neutral-900 tabular-nums">
        ...
        {data.volume && (
          <div>
            <div className="text-[10px] text-neutral-400 uppercase tracking-wider mb-0.5">Vol</div>
            <div className="font-mono text-sm font-semibold text-neutral-900 tabular-nums">{data.volume}</div>
          </div>
        )}
      </div>
    </div>
