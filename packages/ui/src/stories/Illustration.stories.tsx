    ...
    >
      ...
      >
        {svg ? (
          ...
          >
            <span style={{ fontSize: 11, color: "#5A706A" }}>No SVG</span>
          </div>
        )}
        {/* Copy feedback */}
        {copied && (
...
function Gallery() {
  ...
  return (
    <div>
      ...
      >
        {[
          { label: `${ILLUSTRATIONS.length} illustrations`, color: "#10C9A0" },
          { label: "8 categories", color: "#60A5FA" },
          { label: "23 MUSR stories", color: "#A78BFA" },
          { label: "Click to copy SVG", color: "#9BACA6" },
        ].map(({ label, color }) => (
          <span
            key={label}
            style={{
      ...
      >
        <button
          ...
          style={{
            ...
            color: activeCategory === "all" ? "#001A13" : "#5A706A",
            cursor: "pointer",
            fontFamily: "'DM Sans', sans-serif",
          }}
        >
          ...
          return (
            <button
              ...
              style={{
                ...
                color: activeCategory === cat ? "#001A13" : m.color,
                cursor: "pointer",
                fontFamily: "'DM Sans', sans-serif",
              }}
            >
      ...
      {activeCategory === "all" ? (
        ...
        <p style={{ color: "#5A706A", fontSize: 13 }}>
          ...
          >
            ...
            {items.map((item, i) => (
              ...
              >
                ...
                <span
                  style={{ fontSize: 12, color: "#9BACA6", lineHeight: 1.6 }}
                >
                  {item}
                </span>
              </div>
  ...
  render: () => (
    <div style={{ padding: 40, background: "var(--bg-base, #080E0D)" }}>
      ...
      <div style={{ marginBottom: 24 }}>
        <p style={{ fontSize: 12, color: "#5A706A" }}>
...
export const ProUpgrade: Story = {
  ...
  render: () => (
    <div style={{ padding: 40, background: "var(--bg-base, #080E0D)" }}>
      ...
      <p style={{ fontSize: 12, color: "#5A706A", marginBottom: 24 }}>
              ...
              style={{
                ...
                background:
                  activeTab === tab.id
                    ...
                    : "transparent",
                color: activeTab === tab.id ? "#E8EFED" : "#5A706A",
                fontSize: 13,
        ...
        {activeTab === "empty" && (
          ...
          >
            ...
            <div>
              ...
              <p style={{ fontSize: 11, color: "#5A706A" }}>
        ...
        {activeTab === "success" && (
          ...
          >
            ...
            <div>
              ...
              <p style={{ fontSize: 13, color: "#9BACA6", lineHeight: 1.65 }}>
